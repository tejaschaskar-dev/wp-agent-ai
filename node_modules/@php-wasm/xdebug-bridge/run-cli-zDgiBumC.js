import { strictEqual as Zr, notStrictEqual as ts } from "assert";
import Cr, { resolve as ae, dirname as Sn, normalize as es, relative as ns, extname as is, basename as rs } from "path";
import { statSync as Ir, readdirSync as _r, readFileSync as Le, writeFile as ss, lstatSync as os } from "fs";
import { format as Tr, inspect as as } from "util";
import { fileURLToPath as cs } from "url";
import { WebSocketServer as us } from "ws";
import ls from "net";
...
if (vr === "NODE") {
  ...
  if (typeof File > "u") {
    class e extends Blob {
      constructor(s, i, r) {
        super(s);
        let a;
        r?.lastModified && (a = /* @__PURE__ */ new Date()), (!a || isNaN(a.getFullYear())) && (a = /* @__PURE__ */ new Date()), this.lastModifiedDate = a, this.lastModified = a.getMilliseconds(), this.name = i || "";
      }
    }
    global.File = e;
  }
  typeof Blob.prototype.arrayBuffer > "u" && (Blob.prototype.arrayBuffer = function() {
    ...
    return n.readAsArrayBuffer(this), o(n);
  }), typeof Blob.prototype.text > "u" && (Blob.prototype.text = function() {
    const n = new FileReader();
    return n.readAsText(this), o(n);
    ...
    return new ReadableStream({
      ...
      async pull(s) {
        const i = s.byobRequest.view, a = await n.slice(
          e,
          e + i.byteLength
        ).arrayBuffer(), c = new Uint8Array(a);
        new Uint8Array(i.buffer).set(c);
        const g = c.byteLength;
        s.byobRequest.respond(g), e += g, e >= n.size && s.close();
      }
    });
  });
}
...
const ps = "playground-log", ri = (o, ...t) => {
  ...
  switch (typeof o.message == "string" ? Reflect.set(o, "message", Fn(o.message)) : o.message.message && typeof o.message.message == "string" && Reflect.set(
    o.message,
    "message",
    Fn(o.message.message)
  ), o.severity) {
    case yt.Debug:
      console.debug(o.message, ...t);
      break;
    case yt.Info:
      console.info(o.message, ...t);
      break;
    case yt.Warn:
      console.warn(o.message, ...t);
      break;
    case yt.Error:
...
`) : JSON.stringify(o, null, 2), xr = [], si = (o) => {
  ...
  if (o.raw === !0)
    ...
    const t = bs(
      typeof o.message == "object" ? ms(o.message) : o.message,
      o.severity,
      o.prefix ?? se.JS
    );
    si(t);
...
class gs extends EventTarget {
  // constructor
  constructor(t = []) {
    super(), this.fatalErrorEvent = "playground-fatal-error", this.severity = yt.Info, this.handlers = t;
  }
  /**
   * Get all logs.
   * @returns string[]
...
const ys = () => {
  ...
  return o = Fn(o), `[${r}] ${e} ${t.name}: ${o}`;
};
var et = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Xn = { exports: {} }, oe = typeof Reflect == "object" ? Reflect : null, oi = oe && typeof oe.apply == "function" ? oe.apply : function(t, e, n) {
...
rt.prototype.setMaxListeners = function(t) {
  if (typeof t != "number" || t < 0 || Nr(t))
    throw new RangeError('The value of "n" is out of range. It must be a non-negative number. Received ' + t + ".");
  return this._maxListeners = t, this;
};
function Pr(o) {
  return o._maxListeners === void 0 ? rt.defaultMaxListeners : o._maxListeners;
}
...
rt.prototype.emit = function(t) {
  ...
  if (typeof c == "function")
    ...
    for (var g = c.length, p = jr(c, g), n = 0; n < g; ++n)
      oi(p[n], this, e);
  return !0;
};
function Ar(o, t, e, n) {
  var s, i, r;
  if (Se(e), i = o._events, i === void 0 ? (i = o._events = /* @__PURE__ */ Object.create(null), o._eventsCount = 0) : (i.newListener !== void 0 && (o.emit(
    "newListener",
    t,
    e.listener ? e.listener : e
  ), i = o._events), r = i[t]), r === void 0)
    r = i[t] = e, ++o._eventsCount;
  else if (typeof r == "function" ? r = i[t] = n ? [e, r] : [r, e] : n ? r.unshift(e) : r.push(e), s = Pr(o), s > 0 && r.length > s && !r.warned) {
    r.warned = !0;
    ...
    a.name = "MaxListenersExceededWarning", a.emitter = o, a.type = t, a.count = r.length, ws(a);
  }
  return o;
}
rt.prototype.addListener = function(t, e) {
  return Ar(this, t, e, !1);
};
rt.prototype.on = rt.prototype.addListener;
rt.prototype.prependListener = function(t, e) {
  return Ar(this, t, e, !0);
};
function Os() {
  if (!this.fired)
...
function Mr(o, t, e) {
  var n = { fired: !1, wrapFn: void 0, target: o, type: t, listener: e }, s = Os.bind(n);
  return s.listener = e, n.wrapFn = s, s;
}
rt.prototype.once = function(t, e) {
  return Se(e), this.on(t, Mr(this, t, e)), this;
};
rt.prototype.prependOnceListener = function(t, e) {
  return Se(e), this.prependListener(t, Mr(this, t, e)), this;
};
rt.prototype.removeListener = function(t, e) {
  var n, s, i, r, a;
  if (Se(e), s = this._events, s === void 0)
    return this;
  if (n = s[t], n === void 0)
    return this;
  if (n === e || n.listener === e)
    ...
    if (i < 0)
      return this;
    i === 0 ? n.shift() : Es(n, i), n.length === 1 && (s[t] = n[0]), s.removeListener !== void 0 && this.emit("removeListener", t, a || e);
  }
  return this;
};
...
function Lr(o, t, e) {
  ...
  if (n === void 0)
    return [];
  var s = n[t];
  return s === void 0 ? [] : typeof s == "function" ? e ? [s.listener || s] : [s] : e ? Ds(s) : jr(s, s.length);
}
...
rt.listenerCount = function(o, t) {
  return typeof o.listenerCount == "function" ? o.listenerCount(t) : Sr.call(o, t);
};
rt.prototype.listenerCount = Sr;
function Sr(o) {
  var t = this._events;
  if (t !== void 0) {
    var e = t[o];
...
function Cs(o, t) {
  return new Promise(function(e, n) {
    ...
    Fr(o, t, i, { once: !0 }), t !== "error" && Is(o, s, { once: !0 });
  });
}
function Is(o, t, e) {
  typeof o.on == "function" && Fr(o, "error", t, e);
}
function Fr(o, t, e, n) {
...
var $n = Xn.exports;
class _s extends $n.EventEmitter {
  constructor(t = 9229) {
    super(), this.ws = null, this.connected = !1, this.buffer = [], this.wss = new us({ port: t }), this.wss.on("connection", (e) => {
      if (this.ws) {
        e.close();
        return;
      }
...
class Ts extends $n.EventEmitter {
  constructor(t = 9003) {
    super(), this.socket = null, this.buffer = "", this.expectedLength = null, this.server = ls.createServer(), this.server.on("connection", (e) => {
      if (this.socket) {
        e.destroy();
        return;
      }
...
`).map((s) => s.split("	"));
    let n = 0;
    return e.forEach((s) => {
      s.length > 1 && Dt.stringWidth(s[0]) > n && (n = Math.min(Math.floor(this.width * 0.5), Dt.stringWidth(s[0])));
    }), e.forEach((s) => {
      this.div(...s.map((i, r) => ({
        text: i.trim(),
...
`);
  ...
  rowToString(t, e) {
    return this.rasterize(t).forEach((n, s) => {
      ...
      n.forEach((r, a) => {
        ...
        f[Ae] && (i += " ".repeat(f[Ae])), i += ci(t[a], p, "| "), i += p, i += ci(t[a], p, " |"), f[Pe] && (i += " ".repeat(f[Pe])), s === 0 && e.length > 0 && (i = this.renderInline(i, e[e.length - 1]));
      }), e.push({
        text: i.replace(/ +$/, ""),
        span: t.span
      });
  ...
  renderInline(t, e) {
    const n = t.match(/^ */), s = n ? n[0].length : 0, i = e.text, r = Dt.stringWidth(i.trimRight());
...
`), i.border && (s.unshift("." + "-".repeat(this.negatePadding(i) + 2) + "."), s.push("'" + "-".repeat(this.negatePadding(i) + 2) + "'")), i.padding && (s.unshift(...new Array(i.padding[xs] || 0).fill("")), s.push(...new Array(i.padding[Ns] || 0).fill(""))), s.forEach((a, c) => {
  ...
  negatePadding(t) {
    let e = t.width || 0;
    return t.padding && (e -= (t.padding[Ae] || 0) + (t.padding[Pe] || 0)), t.border && (e -= 4), e;
  }
  columnWidths(t) {
    if (!this.wrap)
      return t.map((r) => r.width || Dt.stringWidth(r.text));
    let e = t.length, n = this.width;
    const s = t.map((r) => {
      if (r.width)
        return e--, n -= r.width, r.width;
    }), i = e ? Math.floor(n / e) : 0;
    return s.map((r, a) => r === void 0 ? Math.max(i, As(t[a])) : r);
  }
}
function ci(o, t, e) {
  return o.border ? /[.']-+[.']/.test(t) ? "" : t.trim().length !== 0 ? e : "  " : "";
}
function As(o) {
  const t = o.padding || [], e = 1 + (t[Ae] || 0) + (t[Pe] || 0);
  return o.border ? e + 4 : e;
}
function Ms() {
...
function Ls(o, t) {
  o = o.trim();
  const e = Dt.stringWidth(o);
  return e < t ? " ".repeat(t - e) + o : o;
}
function Ss(o, t) {
  o = o.trim();
  const e = Dt.stringWidth(o);
  return e >= t ? o : " ".repeat(t - e >> 1) + o;
}
let Dt;
function js(o, t) {
  return Dt = t, new Ps({
...
const Rr = new RegExp("\x1B(?:\\[(?:\\d+[ABCDEFGJKSTm]|\\d+;\\d+[Hfm]|\\d+;\\d+;\\d+m|6n|s|u|\\?25[lh])|\\w)", "g");
function Br(o) {
  return o.replace(Rr, "");
}
function Fs(o, t) {
  const [e, n] = o.match(Rr) || ["", ""];
  o = Br(o);
  let s = "";
...
function Bs(o, t) {
  let e = ae(".", o), n;
  for (Ir(e).isDirectory() || (e = Sn(e)); ; ) {
    if (n = t(e, _r(e)), n) return ae(e, n);
    if (e = Sn(n = e), n === e) break;
  }
}
/**
 * @license
...
function le(o) {
    ...
    return o;
  {
    let e = "", n = !1;
    const s = o.match(/^-+/);
    for (let i = s ? s[0].length : 0; i < o.length; i++) {
      let r = o.charAt(i);
...
function Ur(o, t) {
  ...
  for (let s = 0; s < o.length; s++) {
    const i = e.charAt(s), r = o.charAt(s);
...
function Us(o) {
  if (Array.isArray(o))
    return o.map((r) => typeof r != "string" ? r + "" : r);
  o = o.trim();
  let t = 0, e = null, n = null, s = null;
  const i = [];
  for (let r = 0; r < o.length; r++) {
    if (e = n, n = o.charAt(r), n === " " && !s) {
      e !== " " && t++;
      continue;
    }
...
class Xs {
  ...
  parse(t, e) {
    const n = Object.assign({
      ...
      __: void 0,
      key: void 0
    }, e), s = Us(t), i = typeof t == "string", r = $s(Object.assign(/* @__PURE__ */ Object.create(null), n.alias)), a = Object.assign({
      "boolean-negation": !0,
    ...
    }, n.configuration), c = Object.assign(/* @__PURE__ */ Object.create(null), n.default), g = n.configObjects || [], p = n.envPrefix, f = a["populate--"], h = f ? "--" : "_", b = /* @__PURE__ */ Object.create(null), O = /* @__PURE__ */ Object.create(null), D = n.__ || Ft.format, w = {
    ...
    [].concat(n.array || []).filter(Boolean).forEach(function(I) {
      ...
      w.strings[I] = !0, w.keys.push(I);
    }), [].concat(n.number || []).filter(Boolean).forEach(function(I) {
      w.numbers[I] = !0, w.keys.push(I);
    }), [].concat(n.count || []).filter(Boolean).forEach(function(I) {
    ...
    for (let I = 0; I < s.length; I++) {
      ...
      if (v !== "--" && /^-/.test(v) && l(v))
        ...
        for (let gt = 0; gt < q.length; gt++) {
          ...
          if (/[A-Za-z]/.test(q[gt]) && /^-?\d+(\.\d*)?(e-?\d+)?$/.test(z) && Q(z, w.bools) === !1) {
            M(q[gt], z), S = !0;
            break;
          }
          if (q[gt + 1] && q[gt + 1].match(/\W/)) {
            M(q[gt], z), S = !0;
            break;
          } else
            M(q[gt], _(q[gt]));
    ...
    W(T, !0), W(T, !1), X(T), k(), st(T, w.aliases, c, !0), at(T), a["set-placeholder-key"] && Nt(T), Object.keys(w.counts).forEach(function(I) {
      mt(T, I.split(".")) || M(I, 0);
    }), f && E.length && (T[h] = []), E.forEach(function(I) {
      T[h].push(I);
    ...
    function k() {
      typeof g < "u" && g.forEach(function(I) {
        Y(I);
      });
    }
    function W(I, v) {
    ...
    function P(I) {
      return I = I.replace(/^-{3,}/, "--"), I.match(A) || m(I) ? !1 : !K(I, /^-+([^=]+?)=[\s\S]*$/, C, /^-+([^=]+?)$/, /^-+([^=]+?)-$/, /^-+([^=]+?\d+)$/, /^-+([^=]+?)\W+.*$/);
    }
    function _(I) {
      return !Q(I, w.bools) && !Q(I, w.counts) && `${I}` in c ? c[I] : J(nt(I));
    }
    function J(I) {
      return {
        [At.BOOLEAN]: !0,
    ...
    function ht() {
      Object.keys(w.counts).find((I) => Q(I, w.arrays) ? (d = Error(D("Invalid configuration: %s, opts.count excludes opts.array.", I)), !0) : Q(I, w.nargs) ? (d = Error(D("Invalid configuration: %s, opts.count excludes opts.narg.", I)), !0) : !1);
    }
    return {
      aliases: Object.assign({}, w.aliases),
      argv: Object.assign(F, T),
      configuration: a,
...
function $s(o) {
  ...
  let n = !0;
  for (Object.keys(o).forEach(function(s) {
    t.push([].concat(o[s], s));
  }); n; ) {
    n = !1;
    for (let s = 0; s < t.length; s++)
      for (let i = s + 1; i < t.length; i++)
        if (t[s].filter(function(a) {
          return t[i].indexOf(a) !== -1;
        }).length) {
  ...
  return t.forEach(function(s) {
    s = s.filter(function(r, a, c) {
      return c.indexOf(r) === a;
    });
    const i = s.pop();
 ...
 */
var Be, Ue, Xe;
const li = process && process.env && process.env.YARGS_MIN_NODE_VERSION ? Number(process.env.YARGS_MIN_NODE_VERSION) : 12, fi = (Ue = (Be = process == null ? void 0 : process.versions) === null || Be === void 0 ? void 0 : Be.node) !== null && Ue !== void 0 ? Ue : (Xe = process == null ? void 0 : process.version) === null || Xe === void 0 ? void 0 : Xe.slice(1);
if (fi && Number(fi.match(/^([^.]+)/)[1]) < li)
  throw Error(`yargs parser supports a minimum Node.js version of ${li}. Read our version support policy: https://github.com/yargs/yargs-parser#supported-nodejs-versions`);
const qs = process ? process.env : {}, $r = new Xs({
  cwd: process.cwd,
  env: () => qs,
  format: Tr,
  normalize: es,
  ...
  require: (o) => {
    if (typeof require < "u")
      return require(o);
    if (o.match(/\.json$/))
      return JSON.parse(Le(o, "utf8"));
    throw Error("only .json config files are supported in ESM");
  }
}), be = function(t, e) {
  return $r.parse(t.slice(), e).argv;
};
be.detailed = function(o, t) {
  return $r.parse(o.slice(), t);
};
be.camelCase = le;
be.decamelize = Ur;
be.looksLikeNumber = Xr;
function Wr() {
  return Vs() ? 0 : 1;
}
function Vs() {
  return Hs() && !process.defaultApp;
}
function Hs() {
...
function Gs() {
  return process.argv[Wr()];
}
class ut extends Error {
  constructor(t) {
    super(t || "yargs error"), this.name = "YError", Error.captureStackTrace && Error.captureStackTrace(this, ut);
  }
}
const Ys = {
  fs: {
...
class ks {
  ...
  __(...t) {
    ...
    return typeof t[t.length - 1] == "function" && (n = t.pop()), n = n || function() {
      ...
      locale: this.locale,
      cb: n
    })) : n(), Pt.format.apply(Pt.format, [this.cache[this.locale][e] || e].concat(t));
  }
  __n() {
    ...
    const a = [r];
    return ~r.indexOf("%d") && a.push(s), Pt.format.apply(Pt.format, a.concat(t));
  }
  setLocale(t) {
    this.locale = t;
  }
  ...
  _processWriteQueue() {
    const t = this, e = this.writeQueue[0], n = e.directory, s = e.locale, i = e.cb, r = this._resolveLocaleFile(n, s), a = JSON.stringify(this.cache[s], null, 2);
    Pt.fs.writeFile(r, a, "utf-8", function(c) {
      t.writeQueue.shift(), t.writeQueue.length > 0 && t._processWriteQueue(), i(c);
    });
  }
  _readLocaleFile() {
    let t = {};
    ...
    try {
      Pt.fs.readFileSync && (t = JSON.parse(Pt.fs.readFileSync(e, "utf-8")));
    } catch (n) {
...
const Qs = (o) => Ks(o, Ys), Js = "require is not supported by ESM", hi = "loading a directory of commands is not supported yet for ESM";
let ge;
try {
  ge = cs(import.meta.url);
} catch {
  ge = process.cwd();
}
const Zs = ge.substring(0, ge.lastIndexOf("node_modules")), to = {
  assert: {
    notStrictEqual: ts,
    strictEqual: Zr
  },
  ...
  getProcessArgvBin: Gs,
  mainFilename: Zs || process.cwd(),
  Parser: be,
  path: {
    basename: rs,
    dirname: Sn,
  ...
  process: {
    argv: () => process.argv,
    cwd: process.cwd,
    emitWarning: (o, t) => process.emitWarning(o, t),
  ...
  y18n: Qs({
    directory: ae(ge, "../../../locales"),
    updateFiles: !1
  })
};
function Mt(o, t, e, n) {
  e.assert.notStrictEqual(o, t, n);
}
function pi(o, t) {
  t.assert.strictEqual(typeof o, "string");
}
function Me(o) {
...
function pe(o) {
  const e = o.replace(/\s{2,}/g, " ").split(/\s+(?![^[]*]|[^<]*>)/), n = /\.*[\][<>]/g, s = e.shift();
  if (!s)
    throw new Error(`No command found in: ${o}`);
  const i = {
    cmd: s.replace(n, ""),
    demanded: [],
    optional: []
  ...
  return e.forEach((r, a) => {
    let c = !1;
    r = r.replace(/\s/g, ""), /\.+[\]>]/.test(r) && a === e.length - 1 && (c = !0), /^\[/.test(r) ? i.optional.push({
...
const eo = ["first", "second", "third", "fourth", "fifth", "sixth"];
function H(o, t, e) {
  function n() {
    return typeof o == "object" ? [{ demanded: [], optional: [] }, o, t] : [
      pe(`cmd ${o}`),
      t,
      e
    ];
  ...
  try {
    let s = 0;
    const [i, r, a] = n(), c = [].slice.call(r);
    for (; c.length && c[c.length - 1] === void 0; )
      c.pop();
    const g = a || c.length;
    if (g < i.demanded.length)
      throw new ut(`Not enough arguments provided. Expected ${i.demanded.length} but received ${c.length}.`);
    const p = i.demanded.length + i.optional.length;
    if (g > p)
      throw new ut(`Too many arguments provided. Expected max ${p} but received ${g}.`);
    i.demanded.forEach((f) => {
      const h = c.shift(), b = di(h);
      f.cmd.filter((D) => D === b || D === "*").length === 0 && mi(b, f.cmd, s), s += 1;
    }), i.optional.forEach((f) => {
      if (c.length === 0)
        return;
      const h = c.shift(), b = di(h);
      f.cmd.filter((D) => D === b || D === "*").length === 0 && mi(b, f.cmd, s), s += 1;
...
function mi(o, t, e) {
  throw new ut(`Invalid ${eo[e] || "manyith"} argument. Expected ${t.join(" or ")} but received ${o}.`);
}
class no {
  constructor(t) {
  ...
  addMiddleware(t, e, n = !0, s = !1) {
    if (H("<array|function> [boolean] [boolean] [boolean]", [t, e, n], arguments.length), Array.isArray(t)) {
...
function io(o) {
  return o ? o.map((t) => (t.applyBeforeValidation = !1, t)) : [];
}
function de(o, t, e, n) {
  return e.reduce((s, i) => {
    ...
    if (lt(s))
      return s.then((r) => Promise.all([r, i(r, t)])).then(([r, a]) => Object.assign(r, a));
    {
      const r = i(s, t);
      return lt(r) ? r.then((a) => Object.assign(s, a)) : Object.assign(s, r);
    }
  }, o);
}
function me(o, t, e = (n) => {
...
function so(o) {
  ...
  for (let t = 0, e = Object.keys(require.cache), n; t < e.length; t++)
    if (n = require.cache[e[t]], n.exports === o)
      return n;
  return null;
}
const ee = /(^\*)|(^\$0)/;
class oo {
  ...
  addDirectory(t, e, n, s) {
    ...
    s.visit = (r, a, c) => {
      const g = i(r, a, c);
      if (g) {
        if (this.requireCache.has(a))
          return g;
        this.requireCache.add(a), this.addHandler(g);
      }
      return g;
  ...
  addHandler(t, e, n, s, i, r) {
    ...
    if (s = s || (() => {
      ...
      let g = Array.isArray(t.command) || typeof t.command == "string" ? t.command : this.moduleName(t);
      t.aliases && (g = [].concat(g).concat(t.aliases)), this.addHandler(g, this.extractDesc(t), t.builder, t.handler, t.middlewares, t.deprecated);
      return;
    } else if (gi(n)) {
      this.addHandler([t].concat(a), e, n.builder, n.handler, n.middlewares, n.deprecated);
      return;
    }
    if (typeof t == "string") {
      const g = pe(t);
      a = a.map((h) => pe(h).cmd);
      let p = !1;
      const f = [g.cmd].concat(a).filter((h) => ee.test(h) ? (p = !0, !1) : !0);
      f.length === 0 && p && f.push("$0"), p && (g.cmd = f[0], a = f.slice(1), t = t.replace(ee, g.cmd)), a.forEach((h) => {
        this.aliasMap[h] = g.cmd;
      }), e !== !1 && this.usage.command(t, e, p, a, r), this.handlers[g.cmd] = {
        original: t,
        description: e,
        handler: s,
        builder: n || {},
        ...
        demanded: g.demanded,
        optional: g.optional
      }, p && (this.defaultCommand = this.handlers[g.cmd]);
    }
  }
  getCommandHandlers() {
  ...
  runCommand(t, e, n, s, i, r) {
    const a = this.handlers[t] || this.handlers[this.aliasMap[t]] || this.defaultCommand, c = e.getInternalMethods().getContext(), g = c.commands.slice(), p = !t;
    t && (c.commands.push(t), c.fullCommands.push(a.original));
    const f = this.applyBuilderUpdateUsageAndParse(p, a, e, n.aliases, g, s, i, r);
    return lt(f) ? f.then((h) => this.applyMiddlewareAndGetResult(p, a, h.innerArgv, c, i, h.aliases, e)) : this.applyMiddlewareAndGetResult(p, a, f.innerArgv, c, i, f.aliases, e);
  }
  applyBuilderUpdateUsageAndParse(t, e, n, s, i, r, a, c) {
    const g = e.builder;
    let p = n;
    if (Rn(g)) {
    ...
    return this.parseAndUpdateUsage(t, e, p, i, r, a);
  }
  parseAndUpdateUsage(t, e, n, s, i, r) {
    ...
    const a = n.getInternalMethods().runYargsParserAndExecuteCommands(null, void 0, !0, i, r);
    return lt(a) ? a.then((c) => ({
  ...
  usageFromParentCommandsCommandHandler(t, e) {
    const n = ee.test(e.original) ? e.original.replace(ee, "").trim() : e.original, s = t.filter((i) => !ee.test(i));
    return s.push(n), `$0 ${s.join(" ")}`;
  }
  handleValidationAndGetResult(t, e, n, s, i, r, a, c) {
    if (!r.getInternalMethods().getHasOutput()) {
      const g = r.getInternalMethods().runValidation(i, c, r.parsed.error, t);
      n = me(n, (p) => (g(p), p));
    }
    if (e.handler && !r.getInternalMethods().getHasOutput()) {
      r.getInternalMethods().setHasOutput();
      const g = !!r.getOptions().configuration["populate--"];
      r.getInternalMethods().postProcess(n, g, !1, !1), n = de(n, r, a, !1), n = me(n, (p) => {
        const f = e.handler(p);
        return lt(f) ? f.then(() => p) : p;
      }), t || r.getInternalMethods().getUsageInstance().cacheHelpMessage(), lt(n) && !r.getInternalMethods().hasParseCallback() && n.catch((p) => {
        try {
          r.getInternalMethods().getUsageInstance().fail(null, p);
        } catch {
        }
      });
    }
  ...
  applyMiddlewareAndGetResult(t, e, n, s, i, r, a) {
    let c = {};
    if (i)
      return n;
    a.getInternalMethods().getHasOutput() || (c = this.populatePositionals(e, n, s, a));
    const g = this.globalMiddleware.getMiddleware().slice(0).concat(e.middlewares), p = de(n, a, g, !0);
    return lt(p) ? p.then((f) => this.handleValidationAndGetResult(t, e, f, s, r, a, g, c)) : this.handleValidationAndGetResult(t, e, p, s, r, a, g, c);
  }
  populatePositionals(t, e, n, s) {
    e._ = e._.slice(n.commands.length);
    const i = t.demanded.slice(0), r = t.optional.slice(0), a = {};
    for (this.validation.positionalCount(i.length, e._.length); i.length; ) {
      const c = i.shift();
      this.populatePositional(c, e, a);
    }
    for (; r.length; ) {
      const c = r.shift();
      this.populatePositional(c, e, a);
    }
    return e._ = n.commands.concat(e._.map((c) => "" + c)), this.postProcessPositionals(e, a, this.cmdToParseOptions(t.original), s), a;
  }
  ...
  postProcessPositionals(t, e, n, s) {
    ...
    for (const g of Object.keys(n.alias))
      i.alias[g] = (i.alias[g] || []).concat(n.alias[g]);
    i.array = i.array.concat(n.array), i.config = {};
    const r = [];
    if (Object.keys(e).forEach((g) => {
      e[g].map((p) => {
        i.configuration["unknown-options-as-args"] && (i.key[g] = !0), r.push(`--${g}`), r.push(p);
      });
    }), !r.length)
      return;
    const a = Object.assign({}, i.configuration, {
      "populate--": !1
    }), c = this.shim.Parser.detailed(r, Object.assign({}, i, {
      configuration: a
    }));
    if (c.error)
      s.getInternalMethods().getUsageInstance().fail(c.error.message, c.error);
    else {
      const g = Object.keys(e);
      Object.keys(e).forEach((p) => {
        g.push(...c.aliases[p]);
      }), Object.keys(c.argv).forEach((p) => {
        g.includes(p) && (e[p] || (e[p] = c.argv[p]), !this.isInConfigs(s, p) && !this.isDefaulted(s, p) && Object.prototype.hasOwnProperty.call(t, p) && Object.prototype.hasOwnProperty.call(c.argv, p) && (Array.isArray(t[p]) || Array.isArray(c.argv[p])) ? t[p] = [].concat(t[p], c.argv[p]) : t[p] = c.argv[p]);
      });
    }
  }
  isDefaulted(t, e) {
  ...
  runDefaultBuilderOn(t) {
    ...
    if (this.shouldUpdateUsage(t)) {
      const n = ee.test(this.defaultCommand.original) ? this.defaultCommand.original : this.defaultCommand.original.replace(/^[^[\]<>]*/, "$0 ");
      t.getInternalMethods().getUsageInstance().usage(n, this.defaultCommand.description);
    }
    const e = this.defaultCommand.builder;
    if (Rn(e))
      return e(t, !0);
    gi(e) || Object.keys(e).forEach((n) => {
      t.option(n, e[n]);
    });
  }
  moduleName(t) {
...
function ao(o, t, e, n) {
  return new oo(o, t, e, n);
}
function gi(o) {
  return typeof o == "object" && !!o.builder && typeof o.handler == "function";
}
function co(o) {
  return o.every((t) => typeof t == "string");
}
function Rn(o) {
  return typeof o == "function";
}
...
function fe(o) {
  typeof process > "u" || [process.stdout, process.stderr].forEach((t) => {
    const e = t;
    e._handle && e.isTTY && typeof e._handle.setBlocking == "function" && e._handle.setBlocking(o);
  });
}
function fo(o) {
...
function ho(o, t) {
  ...
  let i = null, r = null, a = !0;
  n.showHelpOnFail = function(L = !0, B) {
    const [X, Y] = typeof L == "string" ? [!0, L] : [L, B];
    return o.getInternalMethods().isGlobalContext() && (r = Y), i = Y, a = X, n;
  };
  let c = !1;
  n.fail = function(L, B) {
    const X = o.getInternalMethods().getLoggerInstance();
    if (s.length)
      ...
      if (o.getExitProcess() && fe(!0), !c) {
        c = !0, a && (o.showHelp("error"), X.error()), (L || B) && X.error(L || B);
        const Y = i || r;
        Y && ((L || B) && X.error(""), X.error(Y));
      }
      if (B = B || new ut(L), o.getExitProcess())
        return o.exit(1);
      if (o.getInternalMethods().hasParseCallback())
        return o.exit(1, B);
      throw B;
    }
  };
  let g = [], p = !1;
  n.usage = (N, L) => N === null ? (p = !0, g = [], n) : (p = !1, g.push([N, L || ""]), n), n.getUsage = () => g, n.getUsageDisabled = () => p, n.getPositionalGroupName = () => e("Positionals:");
  let f = [];
  n.example = (N, L) => {
    f.push([N, L || ""]);
  };
  let h = [];
  n.command = function(L, B, X, Y, k = !1) {
    X && (h = h.map((W) => (W[2] = !1, W))), h.push([L, B || "", X, Y, k]);
  }, n.getCommands = () => h;
  let b = {};
  n.describe = function(L, B) {
    Array.isArray(L) ? L.forEach((X) => {
      n.describe(X, B);
    }) : typeof L == "object" ? Object.keys(L).forEach((X) => {
      n.describe(X, L[X]);
    }) : b[L] = B;
  }, n.getDescriptions = () => b;
  let O = [];
  ...
  n.wrap = (N) => {
    D = !0, w = N;
  }, n.getWrap = () => t.getEnv("YARGS_DISABLE_WRAP") ? null : (D || (w = j(), D = !0), w);
  const A = "__yargsString__:";
  n.deferY18nLookup = (N) => A + N, n.help = function() {
    if (E)
      return E;
    d();
    const L = o.customScriptName ? o.$0 : t.path.basename(o.$0), B = o.getDemandedOptions(), X = o.getDemandedCommands(), Y = o.getDeprecatedOptions(), k = o.getGroups(), W = o.getOptions();
    let at = [];
    at = at.concat(Object.keys(b)), at = at.concat(Object.keys(B)), at = at.concat(Object.keys(X)), at = at.concat(Object.keys(W.default)), at = at.filter(F), at = Object.keys(at.reduce((K, m) => (m !== "_" && (K[m] = !0), K), {}));
    const Nt = n.getWrap(), st = t.cliui({
      width: Nt,
      wrap: !!Nt
    });
    if (!p) {
      if (g.length)
        g.forEach((K) => {
          st.div({ text: `${K[0].replace(/\$0/g, L)}` }), K[1] && st.div({ text: `${K[1]}`, padding: [1, 0, 0, 0] });
        }), st.div();
      else if (h.length) {
        let K = null;
        X._ ? K = `${L} <${e("command")}>
...
`, st.div(`${K}`);
    ...
    if (h.length > 1 || h.length === 1 && !h[0][2]) {
      st.div(e("Commands:"));
      ...
      h.forEach((P) => {
        ...
        const J = [];
        P[2] && J.push(`[${e("default")}]`), P[3] && P[3].length && J.push(`[${e("aliases:")} ${P[3].join(", ")}]`), P[4] && (typeof P[4] == "string" ? J.push(`[${e("deprecated: %s", P[4])}]`) : J.push(`[${e("deprecated")}]`)), J.length ? st.div({
          text: J.join(" "),
          padding: [0, 0, 0, 2],
          align: "right"
        }) : st.div();
    ...
    const mt = (Object.keys(W.alias) || []).concat(Object.keys(o.parsed.newAliases) || []);
    at = at.filter((K) => !o.parsed.newAliases[K] && mt.every((m) => (W.alias[m] || []).indexOf(K) === -1));
    const bt = e("Options:");
    ...
    if (Q.filter(({ groupName: K }) => K !== n.getPositionalGroupName()).some(({ normalizedKeys: K, switches: m }) => !K.every((l) => jt(m[l]))) && Q.filter(({ groupName: K }) => K !== n.getPositionalGroupName()).forEach(({ normalizedKeys: K, switches: m }) => {
      ...
      st.div(K), m.forEach((P) => {
        ...
        const it = (v) => typeof v == "string" ? `[${e("deprecated: %s", v)}]` : `[${e("deprecated")}]`, ht = [
          ...
          W.choices && W.choices[P] ? `[${e("choices:")} ${n.stringifiedValues(W.choices[P])}]` : null,
          U(W.default[P], W.defaultDescription[P])
        ].filter(Boolean).join(" ");
        st.span({
          text: we(_),
    ...
    }), f.length && (st.div(e("Examples:")), f.forEach((K) => {
      K[0] = K[0].replace(/\$0/g, L);
    }), f.forEach((K) => {
      K[1] === "" ? st.div({
        text: K[0],
        padding: [0, 2, 0, 2]
      ...
      const K = O.map((m) => m.replace(/\$0/g, L)).join(`
`);
      st.div(`${K}
`);
    }
    return st.toString().replace(/\s*$/, "");
  };
  function C(N, L, B) {
    let X = 0;
    return Array.isArray(N) || (N = Object.values(N).map((Y) => [Y])), N.forEach((Y) => {
      X = Math.max(t.stringWidth(B ? `${B} ${we(Y[0])}` : we(Y[0])) + yi(Y[0]), X);
    }), L && (X = Math.min(X, parseInt((L * 0.5).toString(), 10))), X;
  }
  function d() {
    const N = o.getDemandedOptions(), L = o.getOptions();
    (Object.keys(L.alias) || []).forEach((B) => {
      L.alias[B].forEach((X) => {
        b[X] && n.describe(B, b[X]), X in N && o.demandOption(B, N[X]), L.boolean.includes(X) && o.boolean(B), L.count.includes(X) && o.count(B), L.string.includes(X) && o.string(B), L.normalize.includes(X) && o.normalize(B), L.array.includes(X) && o.array(B), L.number.includes(X) && o.number(B);
      });
    });
  }
  let E;
  ...
  function T(N, L, B, X) {
    ...
    return Object.keys(B).forEach((W) => {
      ...
      k = [W].concat(L[W]), k.some((at) => Y.indexOf(at) !== -1) || B[X].push(W);
    }), Y;
  }
  function F(N) {
    return o.getOptions().hiddenOptions.indexOf(N) < 0 || o.parsed.argv[o.getOptions().showHiddenOpt];
  }
  n.showHelp = (N) => {
    const L = o.getInternalMethods().getLoggerInstance();
    N || (N = "error"), (typeof N == "function" ? N : L[N])(n.help());
  }, n.functionDescription = (N) => ["(", N.name ? t.Parser.decamelize(N.name, "-") : e("generated-value"), ")"].join(""), n.stringifiedValues = function(L, B) {
    let X = "";
    const Y = B || ", ", k = [].concat(L);
    return !L || !k.length || k.forEach((W) => {
      X.length && (X += Y), X += JSON.stringify(W);
    }), X;
  };
  function U(N, L) {
    let B = `[${e("default:")} `;
  ...
  return n.freeze = function() {
    ...
    const B = M.pop();
    B && (L ? (b = { ...B.descriptions, ...b }, h = [...B.commands, ...h], g = [...B.usages, ...g], f = [...B.examples, ...f], O = [...B.epilogs, ...O]) : {
      failMessage: i,
      failureOutput: c,
      usages: g,
      usageDisabled: p,
...
function po(o, t) {
  return Wn(o) ? { text: o.text, indentation: o.indentation + t } : { text: o, indentation: t };
}
function yi(o) {
  return Wn(o) ? o.indentation : 0;
}
function we(o) {
  return Wn(o) ? o.text : o;
}
...
class yo {
  constructor(t, e, n, s) {
    var i, r, a;
    this.yargs = t, this.usage = e, this.command = n, this.shim = s, this.completionKey = "get-yargs-completions", this.aliases = null, this.customCompletionFunction = null, this.indexAfterLastReset = 0, this.zshShell = (a = ((i = this.shim.getEnv("SHELL")) === null || i === void 0 ? void 0 : i.includes("zsh")) || ((r = this.shim.getEnv("ZSH_NAME")) === null || r === void 0 ? void 0 : r.includes("zsh"))) !== null && a !== void 0 ? a : !1;
  }
  defaultCompletion(t, e, n, s) {
    const i = this.command.getCommandHandlers();
    for (let a = 0, c = t.length; a < c; ++a)
      if (i[t[a]] && i[t[a]].builder) {
        const g = i[t[a]].builder;
        if (Rn(g)) {
          this.indexAfterLastReset = a + 1;
          const p = this.yargs.getInternalMethods().reset();
          return g(p, !0), p.argv;
        }
      }
    const r = [];
  ...
  optionCompletions(t, e, n, s) {
    if ((s.match(/^-/) || s === "" && t.length === 0) && !this.previousArgHasChoices(e)) {
      ...
      Object.keys(i.key).forEach((a) => {
        const c = !!i.configuration["boolean-negation"] && i.boolean.includes(a);
        !r.includes(a) && !i.hiddenOptions.includes(a) && !this.argsContainKey(e, a, c) && this.completeOptionKey(a, t, s, c && !!i.default[a]);
      });
    }
  }
  ...
  choicesFromPositionalsCompletions(t, e, n, s) {
    if (s === "" && t.length > 0 && this.previousArgHasChoices(e))
      return;
    const i = this.yargs.getGroups()[this.usage.getPositionalGroupName()] || [], r = Math.max(this.indexAfterLastReset, this.yargs.getInternalMethods().getContext().commands.length + 1), a = i[n._.length - r - 1];
    if (!a)
      return;
    const c = this.yargs.getOptions().choices[a] || [];
    for (const g of c)
      g.startsWith(s) && t.push(g.replace(/:/g, "\\:"));
  }
  getPreviousArgChoices(t) {
    ...
    let a;
    for (const c of r)
      if (Object.prototype.hasOwnProperty.call(i.key, c) && Array.isArray(i.choices[c])) {
        a = i.choices[c];
        break;
      }
    if (a)
      return a.filter((c) => !n || c.startsWith(n));
  }
  ...
  completeOptionKey(t, e, n, s) {
    ...
    let g = t;
    if (this.zshShell) {
      const b = this.usage.getDescriptions(), O = (r = (i = this === null || this === void 0 ? void 0 : this.aliases) === null || i === void 0 ? void 0 : i[t]) === null || r === void 0 ? void 0 : r.find((A) => {
        const C = b[A];
        return typeof C == "string" && C.length > 0;
      }), D = O ? b[O] : void 0, w = (c = (a = b[t]) !== null && a !== void 0 ? a : D) !== null && c !== void 0 ? c : "";
      g = `${t.replace(/:/g, "\\:")}:${w.replace("__yargsString__:", "").replace(/(\r\n|\n|\r)/gm, " ")}`;
    }
    const p = (b) => /^--/.test(b), f = (b) => /^[^0-9]$/.test(b), h = !p(n) && f(t) ? "-" : "--";
    e.push(h + g), s && e.push(h + "no-" + g);
  }
  customCompletion(t, e, n, s) {
    if (Mt(this.customCompletionFunction, null, this.shim), wo(this.customCompletionFunction)) {
      const i = this.customCompletionFunction(n, e);
      return lt(i) ? i.then((r) => {
    ...
    } else return Oo(this.customCompletionFunction) ? this.customCompletionFunction(n, e, (i = s) => this.defaultCompletion(t, e, n, i), (i) => {
      s(null, i);
  ...
  getCompletion(t, e) {
    ...
    return lt(s) ? s.then(i) : i(s);
  }
  generateCompletionScript(t, e) {
    let n = this.zshShell ? go : mo;
...
function Eo(o, t) {
  ...
  for (n = 1; n <= t.length; n++)
    for (s = 1; s <= o.length; s++)
      t.charAt(n - 1) === o.charAt(s - 1) ? e[n][s] = e[n - 1][s - 1] : n > 1 && s > 1 && t.charAt(n - 2) === o.charAt(s - 1) && t.charAt(n - 1) === o.charAt(s - 2) ? e[n][s] = e[n - 2][s - 2] + 1 : e[n][s] = Math.min(e[n - 1][s - 1] + 1, Math.min(e[n][s - 1] + 1, e[n - 1][s] + 1));
  return e[t.length][o.length];
}
const bi = ["$0", "--", "_"];
function Do(o, t, e) {
  const n = e.y18n.__, s = e.y18n.__n, i = {};
  i.nonOptionCount = function(f) {
    const h = o.getDemandedCommands(), O = f._.length + (f["--"] ? f["--"].length : 0) - o.getInternalMethods().getContext().commands.length;
    h._ && (O < h._.min || O > h._.max) && (O < h._.min ? h._.minMsg !== void 0 ? t.fail(h._.minMsg ? h._.minMsg.replace(/\$0/g, O.toString()).replace(/\$1/, h._.min.toString()) : null) : t.fail(s("Not enough non-option arguments: got %s, need at least %s", "Not enough non-option arguments: got %s, need at least %s", O, O.toString(), h._.min.toString())) : O > h._.max && (h._.maxMsg !== void 0 ? t.fail(h._.maxMsg ? h._.maxMsg.replace(/\$0/g, O.toString()).replace(/\$1/, h._.max.toString()) : null) : t.fail(s("Too many non-option arguments: got %s, maximum of %s", "Too many non-option arguments: got %s, maximum of %s", O, O.toString(), h._.max.toString()))));
  }, i.positionalCount = function(f, h) {
    h < f && t.fail(s("Not enough non-option arguments: got %s, need at least %s", "Not enough non-option arguments: got %s, need at least %s", h, h + "", f + ""));
  }, i.requiredArguments = function(f, h) {
    let b = null;
    for (const O of Object.keys(h))
      (!Object.prototype.hasOwnProperty.call(f, O) || typeof f[O] > "u") && (b = b || {}, b[O] = h[O]);
    if (b) {
      const O = [];
      for (const w of Object.keys(b)) {
        const A = b[w];
        A && O.indexOf(A) < 0 && O.push(A);
      }
      const D = O.length ? `
${O.join(`
`)}` : "";
      t.fail(s("Missing required argument: %s", "Missing required arguments: %s", Object.keys(b).length, Object.keys(b).join(", ") + D));
    }
  }, i.unknownArguments = function(f, h, b, O, D = !0) {
    var w;
    const A = o.getInternalMethods().getCommandInstance().getCommands(), C = [], d = o.getInternalMethods().getContext();
    if (Object.keys(f).forEach((E) => {
      !bi.includes(E) && !Object.prototype.hasOwnProperty.call(b, E) && !Object.prototype.hasOwnProperty.call(o.getInternalMethods().getParseContext(), E) && !i.isValidAndSomeAliasIsNotNew(E, h) && C.push(E);
    }), D && (d.commands.length > 0 || A.length > 0 || O) && f._.slice(d.commands.length).forEach((E) => {
      A.includes("" + E) || C.push("" + E);
    }), D) {
      const T = ((w = o.getDemandedCommands()._) === null || w === void 0 ? void 0 : w.max) || 0, F = d.commands.length + T;
      F < f._.length && f._.slice(F).forEach((U) => {
        U = String(U), !d.commands.includes(U) && !C.includes(U) && C.push(U);
      });
    }
    C.length && t.fail(s("Unknown argument: %s", "Unknown arguments: %s", C.length, C.map((E) => E.trim() ? E : `"${E}"`).join(", ")));
  }, i.unknownCommands = function(f) {
    const h = o.getInternalMethods().getCommandInstance().getCommands(), b = [], O = o.getInternalMethods().getContext();
    return (O.commands.length > 0 || h.length > 0) && f._.slice(O.commands.length).forEach((D) => {
      h.includes("" + D) || b.push("" + D);
    }), b.length > 0 ? (t.fail(s("Unknown command: %s", "Unknown commands: %s", b.length, b.join(", "))), !0) : !1;
  }, i.isValidAndSomeAliasIsNotNew = function(f, h) {
    if (!Object.prototype.hasOwnProperty.call(h, f))
      return !1;
    const b = o.parsed.newAliases;
    return [f, ...h[f]].some((O) => !Object.prototype.hasOwnProperty.call(b, O) || !b[f]);
  }, i.limitedChoices = function(f) {
    const h = o.getOptions(), b = {};
    if (!Object.keys(h.choices).length)
      return;
    Object.keys(f).forEach((w) => {
      bi.indexOf(w) === -1 && Object.prototype.hasOwnProperty.call(h.choices, w) && [].concat(f[w]).forEach((A) => {
        h.choices[w].indexOf(A) === -1 && A !== void 0 && (b[w] = (b[w] || []).concat(A));
      });
    });
    const O = Object.keys(b);
    if (!O.length)
      return;
    let D = n("Invalid values:");
    O.forEach((w) => {
      D += `
  ${n("Argument: %s, Given: %s, Choices: %s", w, t.stringifiedValues(b[w]), t.stringifiedValues(h.choices[w]))}`;
    }), t.fail(D);
  };
  let r = {};
  i.implies = function(f, h) {
    H("<string|object> [array|number|string]", [f, h], arguments.length), typeof f == "object" ? Object.keys(f).forEach((b) => {
      i.implies(b, f[b]);
    }) : (o.global(f), r[f] || (r[f] = []), Array.isArray(h) ? h.forEach((b) => i.implies(f, b)) : (Mt(h, void 0, e), r[f].push(h)));
  }, i.getImplied = function() {
    return r;
  };
  function a(p, f) {
    const h = Number(f);
    return f = isNaN(h) ? f : h, typeof f == "number" ? f = p._.length >= f : f.match(/^--no-.+/) ? (f = f.match(/^--no-(.+)/)[1], f = !Object.prototype.hasOwnProperty.call(p, f)) : f = Object.prototype.hasOwnProperty.call(p, f), f;
  }
  i.implications = function(f) {
    const h = [];
    if (Object.keys(r).forEach((b) => {
      ...
      (r[b] || []).forEach((D) => {
        let w = O;
        const A = D;
        w = a(f, w), D = a(f, D), w && !D && h.push(` ${O} -> ${A}`);
      });
    }), h.length) {
...
`;
  ...
  let c = {};
  i.conflicts = function(f, h) {
    H("<string|object> [array|string]", [f, h], arguments.length), typeof f == "object" ? Object.keys(f).forEach((b) => {
      i.conflicts(b, f[b]);
    }) : (o.global(f), c[f] || (c[f] = []), Array.isArray(h) ? h.forEach((b) => i.conflicts(f, b)) : c[f].push(h));
  }, i.getConflicting = () => c, i.conflicting = function(f) {
    Object.keys(f).forEach((h) => {
      c[h] && c[h].forEach((b) => {
        b && f[h] !== void 0 && f[b] !== void 0 && t.fail(n("Arguments %s and %s are mutually exclusive", h, b));
      });
    }), o.getInternalMethods().getParserConfiguration()["strip-dashed"] && Object.keys(c).forEach((h) => {
      c[h].forEach((b) => {
        b && f[e.Parser.camelCase(h)] !== void 0 && f[e.Parser.camelCase(b)] !== void 0 && t.fail(n("Arguments %s and %s are mutually exclusive", h, b));
      });
    });
  }, i.recommendCommands = function(f, h) {
    h = h.sort((w, A) => A.length - w.length);
    let O = null, D = 1 / 0;
    for (let w = 0, A; (A = h[w]) !== void 0; w++) {
      const C = Eo(f, A);
      C <= 3 && C < D && (D = C, O = A);
    }
    O && t.fail(n("Did you mean %s?", O));
  }, i.reset = function(f) {
    return r = ye(r, (h) => !f[h]), c = ye(c, (h) => !f[h]), i;
  };
  const g = [];
  return i.freeze = function() {
    ...
    const f = g.pop();
    Mt(f, void 0, e), { implied: r, conflicting: c } = f;
  }, i;
}
let Bn = [], he;
function Un(o, t, e, n) {
  he = n;
  let s = {};
  if (Object.prototype.hasOwnProperty.call(o, "extends")) {
    if (typeof o.extends != "string")
      return s;
    const i = /\.json|\..*rc$/.test(o.extends);
    let r = null;
    if (i)
      r = Io(t, o.extends);
    else
      try {
        r = require.resolve(o.extends);
      } catch {
        return o;
      }
    Co(r), Bn.push(r), s = i ? JSON.parse(he.readFileSync(r, "utf8")) : require(o.extends), delete o.extends, s = Un(s, he.path.dirname(r), e, he);
  }
  return Bn = [], e ? qr(s, o) : Object.assign({}, s, o);
}
function Co(o) {
  if (Bn.indexOf(o) > -1)
    throw new ut(`Circular extended configurations: '${o}'.`);
}
function Io(o, t) {
  return he.path.resolve(o, t);
}
function qr(o, t) {
  const e = {};
  function n(s) {
  ...
  for (const s of Object.keys(t))
    n(t[s]) && n(e[s]) ? e[s] = qr(o[s], t[s]) : e[s] = t[s];
  return e;
}
var V = function(o, t, e, n, s) {
  if (n === "m") throw new TypeError("Private method is not writable");
  if (n === "a" && !s) throw new TypeError("Private accessor was defined without a setter");
  if (typeof t == "function" ? o !== t || !s : !t.has(o)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
  return n === "a" ? s.call(o, e) : s ? s.value = e : t.set(o, e), e;
}, y = function(o, t, e, n) {
...
class To {
  ...
  addHelpOpt(t, e) {
    const n = "help";
    return H("[string|boolean] [string]", [t, e], arguments.length), y(this, Tt, "f") && (this[$e](y(this, Tt, "f")), V(this, Tt, null, "f")), t === !1 && e === void 0 ? this : (V(this, Tt, typeof t == "string" ? t : n, "f"), this.boolean(y(this, Tt, "f")), this.describe(y(this, Tt, "f"), e || y(this, tt, "f").deferY18nLookup("Show help")), this);
  }
  help(t, e) {
    return this.addHelpOpt(t, e);
  }
  addShowHiddenOpt(t, e) {
    if (H("[string|boolean] [string]", [t, e], arguments.length), t === !1 && e === void 0)
      return this;
    const n = typeof t == "string" ? t : y(this, Oe, "f");
    return this.boolean(n), this.describe(n, e || y(this, tt, "f").deferY18nLookup("Show hidden options")), y(this, G, "f").showHiddenOpt = n, this;
  }
  showHidden(t, e) {
    return this.addShowHiddenOpt(t, e);
  }
  alias(t, e) {
    return H("<object|string|array> [string|array]", [t, e], arguments.length), this[Ve](this.alias.bind(this), "alias", t, e), this;
  }
  array(t) {
    return H("<array|string>", [t], arguments.length), this[Wt]("array", t), this[Zt](t), this;
  }
  boolean(t) {
    return H("<array|string>", [t], arguments.length), this[Wt]("boolean", t), this[Zt](t), this;
  }
  check(t, e) {
    return H("<function> [boolean]", [t, e], arguments.length), this.middleware((n, s) => me(() => t(n, s.getOptions()), (i) => (i ? (typeof i == "string" || i instanceof Error) && y(this, tt, "f").fail(i.toString(), i) : y(this, tt, "f").fail(y(this, Z, "f").y18n.__("Argument check failed: %s", t.toString())), n), (i) => (y(this, tt, "f").fail(i.message ? i.message : i.toString(), i), n)), !1, e), this;
  }
  choices(t, e) {
    return H("<object|string|array> [string|array]", [t, e], arguments.length), this[Ve](this.choices.bind(this), "choices", t, e), this;
  }
  coerce(t, e) {
    if (H("<object|string|array> [function]", [t, e], arguments.length), Array.isArray(t)) {
      if (!e)
        throw new ut("coerce callback must be provided");
      for (const n of t)
        this.coerce(n, e);
      return this;
    ...
    if (!e)
      throw new ut("coerce callback must be provided");
    return y(this, G, "f").key[t] = !0, y(this, _t, "f").addCoerceMiddleware((n, s) => {
      let i;
      return Object.prototype.hasOwnProperty.call(n, t) ? me(() => (i = s.getAliases(), e(n[t])), (a) => {
        n[t] = a;
        const c = s.getInternalMethods().getParserConfiguration()["strip-aliased"];
        if (i[t] && c !== !0)
          for (const g of i[t])
            n[g] = a;
        return n;
      }, (a) => {
        throw new ut(a.message);
      }) : n;
    }, t), this;
  }
  conflicts(t, e) {
    return H("<string|object> [string|array]", [t, e], arguments.length), y(this, ot, "f").conflicts(t, e), this;
  }
  config(t = "config", e, n) {
    return H("[object|string] [string|function] [function]", [t, e, n], arguments.length), typeof t == "object" && !Array.isArray(t) ? (t = Un(t, y(this, Vt, "f"), this[Qt]()["deep-merge-config"] || !1, y(this, Z, "f")), y(this, G, "f").configObjects = (y(this, G, "f").configObjects || []).concat(t), this) : (typeof e == "function" && (n = e, e = void 0), this.describe(t, e || y(this, tt, "f").deferY18nLookup("Path to JSON config file")), (Array.isArray(t) ? t : [t]).forEach((s) => {
      y(this, G, "f").config[s] = n || !0;
    }), this);
  }
  completion(t, e, n) {
    return H("[string] [string|boolean|function] [function]", [t, e, n], arguments.length), typeof e == "function" && (n = e, e = void 0), V(this, wt, t || y(this, wt, "f") || "completion", "f"), !e && e !== !1 && (e = "generate completion script"), this.command(y(this, wt, "f"), e), n && y(this, Ct, "f").registerFunction(n), this;
  }
  command(t, e, n, s, i, r) {
    return H("<string|array|object> [string|boolean] [function|object] [function] [array] [boolean|string]", [t, e, n, s, i, r], arguments.length), y(this, ct, "f").addHandler(t, e, n, s, i, r), this;
  }
  ...
  commandDir(t, e) {
    ...
    const n = y(this, Ie, "f") || y(this, Z, "f").require;
    return y(this, ct, "f").addDirectory(t, n, y(this, Z, "f").getCallerFile(), e), this;
  }
  count(t) {
    return H("<array|string>", [t], arguments.length), this[Wt]("count", t), this[Zt](t), this;
  }
  default(t, e, n) {
    return H("<object|string|array> [*] [string]", [t, e, n], arguments.length), n && (pi(t, y(this, Z, "f")), y(this, G, "f").defaultDescription[t] = n), typeof e == "function" && (pi(t, y(this, Z, "f")), y(this, G, "f").defaultDescription[t] || (y(this, G, "f").defaultDescription[t] = y(this, tt, "f").functionDescription(e)), e = e.call()), this[re](this.default.bind(this), "default", t, e), this;
  }
  defaults(t, e, n) {
    return this.default(t, e, n);
  }
  demandCommand(t = 1, e, n, s) {
    return H("[number] [number|string] [string|null|undefined] [string|null|undefined]", [t, e, n, s], arguments.length), typeof e != "number" && (n = e, e = 1 / 0), this.global("_", !1), y(this, G, "f").demandedCommands._ = {
      min: t,
      max: e,
      minMsg: n,
      maxMsg: s
  ...
  demand(t, e, n) {
    return Array.isArray(e) ? (e.forEach((s) => {
      Mt(n, !0, y(this, Z, "f")), this.demandOption(s, n);
    }), e = 1 / 0) : typeof e != "number" && (n = e, e = 1 / 0), typeof t == "number" ? (Mt(n, !0, y(this, Z, "f")), this.demandCommand(t, e, n, n)) : Array.isArray(t) ? t.forEach((s) => {
      Mt(n, !0, y(this, Z, "f")), this.demandOption(s, n);
    }) : typeof n == "string" ? this.demandOption(t, n) : (n === !0 || typeof n > "u") && this.demandOption(t), this;
  }
  demandOption(t, e) {
    return H("<object|string|array> [string]", [t, e], arguments.length), this[re](this.demandOption.bind(this), "demandedOptions", t, e), this;
  }
  deprecateOption(t, e) {
    return H("<string> [string|boolean]", [t, e], arguments.length), y(this, G, "f").deprecatedOptions[t] = e, this;
  }
  describe(t, e) {
    return H("<object|string|array> [string]", [t, e], arguments.length), this[Ge](t, !0), y(this, tt, "f").describe(t, e), this;
  }
  detectLocale(t) {
    return H("<boolean>", [t], arguments.length), V(this, Ht, t, "f"), this;
  }
  env(t) {
    return H("[string|boolean]", [t], arguments.length), t === !1 ? delete y(this, G, "f").envPrefix : y(this, G, "f").envPrefix = t || "", this;
  }
  epilogue(t) {
    return H("<string>", [t], arguments.length), y(this, tt, "f").epilog(t), this;
  }
  epilog(t) {
    return this.epilogue(t);
  }
  example(t, e) {
    return H("<string|array> [string]", [t, e], arguments.length), Array.isArray(t) ? t.forEach((n) => this.example(...n)) : y(this, tt, "f").example(t, e), this;
  }
  exit(t, e) {
    V(this, Ot, !0, "f"), V(this, Xt, e, "f"), y(this, It, "f") && y(this, Z, "f").process.exit(t);
  }
  exitProcess(t = !0) {
    return H("[boolean]", [t], arguments.length), V(this, It, t, "f"), this;
  }
  fail(t) {
    if (H("<function|boolean>", [t], arguments.length), typeof t == "boolean" && t !== !1)
      throw new ut("Invalid first argument. Expected function or boolean 'false'");
    return y(this, tt, "f").failFn(t), this;
  }
  getAliases() {
    return this.parsed ? this.parsed.aliases : {};
  }
  async getCompletion(t, e) {
    return H("<array> [function]", [t, e], arguments.length), e ? y(this, Ct, "f").getCompletion(t, e) : new Promise((n, s) => {
      y(this, Ct, "f").getCompletion(t, (i, r) => {
        i ? s(i) : n(r);
      });
    });
  }
  getDemandedOptions() {
    return H([], 0), y(this, G, "f").demandedOptions;
  }
  getDemandedCommands() {
    return H([], 0), y(this, G, "f").demandedCommands;
  }
  getDeprecatedOptions() {
    return H([], 0), y(this, G, "f").deprecatedOptions;
  }
  getDetectLocale() {
    return y(this, Ht, "f");
  }
  ...
  getGroups() {
    return Object.assign({}, y(this, Lt, "f"), y(this, Gt, "f"));
  }
  getHelp() {
    if (V(this, Ot, !0, "f"), !y(this, tt, "f").hasCachedHelpMessage()) {
      if (!this.parsed) {
        const e = this[ue](y(this, $t, "f"), void 0, void 0, 0, !0);
        if (lt(e))
          return e.then(() => y(this, tt, "f").help());
      }
      const t = y(this, ct, "f").runDefaultBuilderOn(this);
      if (lt(t))
        return t.then(() => y(this, tt, "f").help());
    }
    return Promise.resolve(y(this, tt, "f").help());
  }
  getOptions() {
    return y(this, G, "f");
  }
  ...
  global(t, e) {
    return H("<string|array> [boolean]", [t, e], arguments.length), t = [].concat(t), e !== !1 ? y(this, G, "f").local = y(this, G, "f").local.filter((n) => t.indexOf(n) === -1) : t.forEach((n) => {
      y(this, G, "f").local.includes(n) || y(this, G, "f").local.push(n);
    }), this;
  }
  group(t, e) {
    H("<string|array> <string>", [t, e], arguments.length);
    const n = y(this, Gt, "f")[e] || y(this, Lt, "f")[e];
    y(this, Gt, "f")[e] && delete y(this, Gt, "f")[e];
    const s = {};
    return y(this, Lt, "f")[e] = (n || []).concat(t).filter((i) => s[i] ? !1 : s[i] = !0), this;
  }
  hide(t) {
    return H("<string>", [t], arguments.length), y(this, G, "f").hiddenOptions.push(t), this;
  }
  implies(t, e) {
    return H("<string|object> [number|string|array]", [t, e], arguments.length), y(this, ot, "f").implies(t, e), this;
  }
  locale(t) {
    return H("[string]", [t], arguments.length), t === void 0 ? (this[We](), y(this, Z, "f").y18n.getLocale()) : (V(this, Ht, !1, "f"), y(this, Z, "f").y18n.setLocale(t), this);
  }
  middleware(t, e, n) {
    return y(this, _t, "f").addMiddleware(t, !!e, n);
  }
  nargs(t, e) {
    return H("<string|object|array> [number]", [t, e], arguments.length), this[re](this.nargs.bind(this), "narg", t, e), this;
  }
  normalize(t) {
    return H("<array|string>", [t], arguments.length), this[Wt]("normalize", t), this;
  }
  number(t) {
    return H("<array|string>", [t], arguments.length), this[Wt]("number", t), this[Zt](t), this;
  }
  option(t, e) {
    if (H("<string|object> [object]", [t, e], arguments.length), typeof t == "object")
      Object.keys(t).forEach((n) => {
        this.options(n, t[n]);
      });
    else {
      typeof e != "object" && (e = {}), this[Zt](t), y(this, St, "f") && (t === "version" || e?.alias === "version") && this[Ei]([
...
`), void 0, "versionWarning"), y(this, G, "f").key[t] = !0, e.alias && this.alias(t, e.alias);
      const n = e.deprecate || e.deprecated;
      n && this.deprecateOption(t, n);
      const s = e.demand || e.required || e.require;
      s && this.demand(t, s), e.demandOption && this.demandOption(t, typeof e.demandOption == "string" ? e.demandOption : void 0), e.conflicts && this.conflicts(t, e.conflicts), "default" in e && this.default(t, e.default), e.implies !== void 0 && this.implies(t, e.implies), e.nargs !== void 0 && this.nargs(t, e.nargs), e.config && this.config(t, e.configParser), e.normalize && this.normalize(t), e.choices && this.choices(t, e.choices), e.coerce && this.coerce(t, e.coerce), e.group && this.group(t, e.group), (e.boolean || e.type === "boolean") && (this.boolean(t), e.alias && this.boolean(e.alias)), (e.array || e.type === "array") && (this.array(t), e.alias && this.array(e.alias)), (e.number || e.type === "number") && (this.number(t), e.alias && this.number(e.alias)), (e.string || e.type === "string") && (this.string(t), e.alias && this.string(e.alias)), (e.count || e.type === "count") && this.count(t), typeof e.global == "boolean" && this.global(t, e.global), e.defaultDescription && (y(this, G, "f").defaultDescription[t] = e.defaultDescription), e.skipValidation && this.skipValidation(t);
      const i = e.describe || e.description || e.desc, r = y(this, tt, "f").getDescriptions();
  ...
  parse(t, e, n) {
    H("[string|array] [function|boolean|object] [function]", [t, e, n], arguments.length), this[Di](), typeof t > "u" && (t = y(this, $t, "f")), typeof e == "object" && (V(this, zt, e, "f"), e = n), typeof e == "function" && (V(this, Et, e, "f"), e = !1), e || V(this, $t, t, "f"), y(this, Et, "f") && V(this, It, !1, "f");
    const s = this[ue](t, !!e), i = this.parsed;
    return y(this, Ct, "f").setParsed(this.parsed), lt(s) ? s.then((r) => (y(this, Et, "f") && y(this, Et, "f").call(this, y(this, Xt, "f"), r, y(this, dt, "f")), r)).catch((r) => {
      throw y(this, Et, "f") && y(this, Et, "f")(r, this.parsed.argv, y(this, dt, "f")), r;
    }).finally(() => {
      this[Ye](), this.parsed = i;
    }) : (y(this, Et, "f") && y(this, Et, "f").call(this, y(this, Xt, "f"), s, y(this, dt, "f")), this[Ye](), this.parsed = i, s);
  }
  parseAsync(t, e, n) {
    const s = this.parse(t, e, n);
    return lt(s) ? s : Promise.resolve(s);
  }
  parseSync(t, e, n) {
    const s = this.parse(t, e, n);
    if (lt(s))
      throw new ut(".parseSync() must not be used with asynchronous builders, handlers, or middleware");
    return s;
  }
  parserConfiguration(t) {
    return H("<object>", [t], arguments.length), V(this, _e, t, "f"), this;
  }
  pkgConf(t, e) {
    H("<string> [string]", [t, e], arguments.length);
    let n = null;
    const s = this[qe](e || y(this, Vt, "f"));
    return s[t] && typeof s[t] == "object" && (n = Un(s[t], e || y(this, Vt, "f"), this[Qt]()["deep-merge-config"] || !1, y(this, Z, "f")), y(this, G, "f").configObjects = (y(this, G, "f").configObjects || []).concat(n)), this;
  }
  positional(t, e) {
    H("<string> <object>", [t, e], arguments.length);
    const n = [
    ...
    e = ye(e, (r, a) => r === "type" && !["string", "number", "boolean"].includes(a) ? !1 : n.includes(r));
    const s = y(this, ce, "f").fullCommands[y(this, ce, "f").fullCommands.length - 1], i = s ? y(this, ct, "f").cmdToParseOptions(s) : {
      array: [],
      alias: {},
      default: {},
      demand: {}
    };
    return Me(i).forEach((r) => {
      const a = i[r];
      Array.isArray(a) ? a.indexOf(t) !== -1 && (e[r] = !0) : a[t] && !(r in e) && (e[r] = a[t]);
    }), this.group(t, y(this, tt, "f").getPositionalGroupName()), this.option(t, e);
  }
  recommendCommands(t = !0) {
    return H("[boolean]", [t], arguments.length), V(this, Te, t, "f"), this;
  }
  required(t, e, n) {
  ...
  requiresArg(t) {
    return H("<array|string|object> [number]", [t], arguments.length), typeof t == "string" && y(this, G, "f").narg[t] ? this : (this[re](this.requiresArg.bind(this), "narg", t, NaN), this);
  }
  showCompletionScript(t, e) {
    return H("[string] [string]", [t, e], arguments.length), t = t || this.$0, y(this, ne, "f").log(y(this, Ct, "f").generateCompletionScript(t, e || y(this, wt, "f") || "completion")), this;
  }
  showHelp(t) {
    if (H("[string|function]", [t], arguments.length), V(this, Ot, !0, "f"), !y(this, tt, "f").hasCachedHelpMessage()) {
      if (!this.parsed) {
        const n = this[ue](y(this, $t, "f"), void 0, void 0, 0, !0);
        if (lt(n))
          return n.then(() => {
            y(this, tt, "f").showHelp(t);
          }), this;
      }
      const e = y(this, ct, "f").runDefaultBuilderOn(this);
      if (lt(e))
        return e.then(() => {
          y(this, tt, "f").showHelp(t);
        }), this;
    }
    return y(this, tt, "f").showHelp(t), this;
  }
  scriptName(t) {
    return this.customScriptName = !0, this.$0 = t, this;
  }
  showHelpOnFail(t, e) {
    return H("[boolean|string] [string]", [t, e], arguments.length), y(this, tt, "f").showHelpOnFail(t, e), this;
  }
  showVersion(t) {
    return H("[string|function]", [t], arguments.length), y(this, tt, "f").showVersion(t), this;
  }
  skipValidation(t) {
    return H("<array|string>", [t], arguments.length), this[Wt]("skipValidation", t), this;
  }
  strict(t) {
    return H("[boolean]", [t], arguments.length), V(this, Yt, t !== !1, "f"), this;
  }
  strictCommands(t) {
    return H("[boolean]", [t], arguments.length), V(this, kt, t !== !1, "f"), this;
  }
  strictOptions(t) {
    return H("[boolean]", [t], arguments.length), V(this, Kt, t !== !1, "f"), this;
  }
  string(t) {
    return H("<array|string>", [t], arguments.length), this[Wt]("string", t), this[Zt](t), this;
  }
  terminalWidth() {
    return H([], 0), y(this, Z, "f").process.stdColumns;
  }
  updateLocale(t) {
    return this.updateStrings(t);
  }
  updateStrings(t) {
    return H("<object>", [t], arguments.length), V(this, Ht, !1, "f"), y(this, Z, "f").y18n.updateLocale(t), this;
  }
  usage(t, e, n, s) {
    if (H("<string|null|undefined> [string|boolean] [function|object] [function]", [t, e, n, s], arguments.length), e !== void 0) {
      if (Mt(t, null, y(this, Z, "f")), (t || "").match(/^\$0( |$)/))
        return this.command(t, e, n, s);
      throw new ut(".usage() description must start with $0 if being used as alias for .command()");
    } else
  ...
  version(t, e, n) {
    const s = "version";
    if (H("[boolean|string] [string] [string]", [t, e, n], arguments.length), y(this, St, "f") && (this[$e](y(this, St, "f")), y(this, tt, "f").version(void 0), V(this, St, null, "f")), arguments.length === 0)
      n = this[_i](), t = s;
    ...
    return V(this, St, typeof t == "string" ? t : s, "f"), e = e || y(this, tt, "f").deferY18nLookup("Show version number"), y(this, tt, "f").version(n || void 0), this.boolean(y(this, St, "f")), this.describe(y(this, St, "f"), e), this;
  }
  wrap(t) {
...
`, "f"), V(this, dt, y(this, dt, "f") + t.join(" "), "f");
  ...
  [$e](t) {
    Me(y(this, G, "f")).forEach((e) => {
      if (/* @__PURE__ */ ((s) => s === "configObjects")(e))
        return;
      const n = y(this, G, "f")[e];
      Array.isArray(n) ? n.includes(t) && n.splice(n.indexOf(t), 1) : typeof n == "object" && delete n[t];
    }), delete y(this, tt, "f").getDescriptions()[t];
  }
  [Ei](t, e, n) {
    y(this, Ee, "f")[n] || (y(this, Z, "f").process.emitWarning(t, e), y(this, Ee, "f")[n] = !0);
  }
  [Di]() {
    y(this, De, "f").push({
      options: y(this, G, "f"),
      configObjects: y(this, G, "f").configObjects.slice(0),
      exitProcess: y(this, It, "f"),
      groups: y(this, Lt, "f"),
      strict: y(this, Yt, "f"),
      strictCommands: y(this, kt, "f"),
      strictOptions: y(this, Kt, "f"),
      completionCommand: y(this, wt, "f"),
      output: y(this, dt, "f"),
      exitError: y(this, Xt, "f"),
      hasOutput: y(this, Ot, "f"),
      parsed: this.parsed,
      parseFn: y(this, Et, "f"),
      parseContext: y(this, zt, "f")
    }), y(this, tt, "f").freeze(), y(this, ot, "f").freeze(), y(this, ct, "f").freeze(), y(this, _t, "f").freeze();
  }
  [Ci]() {
    let t = "", e;
    return /\b(node|iojs|electron)(\.exe)?$/.test(y(this, Z, "f").process.argv()[0]) ? e = y(this, Z, "f").process.argv().slice(1, 2) : e = y(this, Z, "f").process.argv().slice(0, 1), t = e.map((n) => {
      const s = this[Fi](y(this, Vt, "f"), n);
      return n.match(/^(\/|([a-zA-Z]:)?\\)/) && s.length < n.length ? s : n;
    }).join(" ").trim(), y(this, Z, "f").getEnv("_") && y(this, Z, "f").getProcessArgvBin() === y(this, Z, "f").getEnv("_") && (t = y(this, Z, "f").getEnv("_").replace(`${y(this, Z, "f").path.dirname(y(this, Z, "f").process.execPath())}/`, "")), t;
  }
  [Qt]() {
    return y(this, _e, "f");
  }
  ...
  [We]() {
    if (!y(this, Ht, "f"))
      return;
    const t = y(this, Z, "f").getEnv("LC_ALL") || y(this, Z, "f").getEnv("LC_MESSAGES") || y(this, Z, "f").getEnv("LANG") || y(this, Z, "f").getEnv("LANGUAGE") || "en_US";
    this.locale(t.replace(/[.:].*/, ""));
  }
  [_i]() {
    return this[qe]().version || "unknown";
  }
  [Ti](t) {
    const e = t["--"] ? t["--"] : t._;
    for (let n = 0, s; (s = e[n]) !== void 0; n++)
      y(this, Z, "f").Parser.looksLikeNumber(s) && Number.isSafeInteger(Math.floor(parseFloat(`${s}`))) && (e[n] = Number(s));
    return t;
  }
  [qe](t) {
    const e = t || "*";
    if (y(this, ie, "f")[e])
      return y(this, ie, "f")[e];
    let n = {};
    try {
      let s = t || y(this, Z, "f").mainFilename;
      !t && y(this, Z, "f").path.extname(s) && (s = y(this, Z, "f").path.dirname(s));
      const i = y(this, Z, "f").findUp(s, (r, a) => {
        if (a.includes("package.json"))
          return "package.json";
      });
      Mt(i, void 0, y(this, Z, "f")), n = JSON.parse(y(this, Z, "f").readFileSync(i, "utf8"));
    } catch {
    }
    return y(this, ie, "f")[e] = n || {}, y(this, ie, "f")[e];
  }
  [Wt](t, e) {
    e = [].concat(e), e.forEach((n) => {
      n = this[ze](n), y(this, G, "f")[t].push(n);
    });
  }
  [re](t, e, n, s) {
    this[He](t, e, n, s, (i, r, a) => {
      y(this, G, "f")[i][r] = a;
    });
  }
  [Ve](t, e, n, s) {
    this[He](t, e, n, s, (i, r, a) => {
      y(this, G, "f")[i][r] = (y(this, G, "f")[i][r] || []).concat(a);
    });
  }
  [He](t, e, n, s, i) {
    if (Array.isArray(n))
  ...
  [Ge](t, e) {
    return this[re](this[Ge].bind(this), "key", t, e), this;
  }
  [Ye]() {
    var t, e, n, s, i, r, a, c, g, p, f, h;
    const b = y(this, De, "f").pop();
    Mt(b, void 0, y(this, Z, "f"));
    let O;
    t = this, e = this, n = this, s = this, i = this, r = this, a = this, c = this, g = this, p = this, f = this, h = this, {
      options: { set value(D) {
        V(t, G, D, "f");
      } }.value,
      configObjects: O,
      exitProcess: { set value(D) {
        V(e, It, D, "f");
      } }.value,
      groups: { set value(D) {
        V(n, Lt, D, "f");
      ...
      exitError: { set value(D) {
        V(i, Xt, D, "f");
      } }.value,
      hasOutput: { set value(D) {
        V(r, Ot, D, "f");
      } }.value,
      parsed: this.parsed,
      strict: { set value(D) {
      ...
      strictCommands: { set value(D) {
        V(c, kt, D, "f");
      } }.value,
      strictOptions: { set value(D) {
        V(g, Kt, D, "f");
      } }.value,
      completionCommand: { set value(D) {
        V(p, wt, D, "f");
      } }.value,
      parseFn: { set value(D) {
        V(f, Et, D, "f");
      } }.value,
      parseContext: { set value(D) {
        V(h, zt, D, "f");
      } }.value
  ...
  getInternalMethods() {
    return {
      ...
      getParseContext: this[Mi].bind(this),
      getParserConfiguration: this[Qt].bind(this),
      ...
      runValidation: this[Ke].bind(this),
      runYargsParserAndExecuteCommands: this[ue].bind(this),
  ...
  [Jt](t, e, n, s) {
    return n || lt(t) || (e || (t = this[wi](t)), (this[Qt]()["parse-positional-numbers"] || this[Qt]()["parse-positional-numbers"] === void 0) && (t = this[Ti](t)), s && (t = de(t, this, y(this, _t, "f").getMiddleware(), !1))), t;
  }
  [ke](t = {}) {
    V(this, G, y(this, G, "f") || {}, "f");
    const e = {};
    e.local = y(this, G, "f").local || [], e.configObjects = y(this, G, "f").configObjects || [];
    const n = {};
    e.local.forEach((r) => {
      n[r] = !0, (t[r] || []).forEach((a) => {
        n[a] = !0;
      });
    }), Object.assign(y(this, Gt, "f"), Object.keys(y(this, Lt, "f")).reduce((r, a) => {
      const c = y(this, Lt, "f")[a].filter((g) => !(g in n));
      return c.length > 0 && (r[a] = c), r;
    }, {})), V(this, Lt, {}, "f");
    const s = [
      "array",
      "boolean",
    ...
    return s.forEach((r) => {
      e[r] = (y(this, G, "f")[r] || []).filter((a) => !n[a]);
    }), i.forEach((r) => {
      e[r] = ye(y(this, G, "f")[r], (a) => !n[a]);
    }), e.envPrefix = y(this, G, "f").envPrefix, V(this, G, e, "f"), V(this, tt, y(this, tt, "f") ? y(this, tt, "f").reset(n) : ho(this, y(this, Z, "f")), "f"), V(this, ot, y(this, ot, "f") ? y(this, ot, "f").reset(n) : Do(this, y(this, tt, "f"), y(this, Z, "f")), "f"), V(this, ct, y(this, ct, "f") ? y(this, ct, "f").reset() : ao(y(this, tt, "f"), y(this, ot, "f"), y(this, _t, "f"), y(this, Z, "f")), "f"), y(this, Ct, "f") || V(this, Ct, bo(this, y(this, tt, "f"), y(this, ct, "f"), y(this, Z, "f")), "f"), y(this, _t, "f").reset(), V(this, wt, null, "f"), V(this, dt, "", "f"), V(this, Xt, null, "f"), V(this, Ot, !1, "f"), this.parsed = !1, this;
  }
  [Fi](t, e) {
    return y(this, Z, "f").path.relative(t, e);
  }
  [ue](t, e, n, s = 0, i = !1) {
    let r = !!n || i;
    t = t || y(this, $t, "f"), y(this, G, "f").__ = y(this, Z, "f").y18n.__, y(this, G, "f").configuration = this[Qt]();
    const a = !!y(this, G, "f").configuration["populate--"], c = Object.assign({}, y(this, G, "f").configuration, {
      "populate--": !0
    }), g = y(this, Z, "f").Parser.detailed(t, Object.assign({}, y(this, G, "f"), {
      configuration: { "parse-positional-numbers": !1, ...c }
    })), p = Object.assign(g.argv, y(this, zt, "f"));
    let f;
    const h = g.aliases;
    let b = !1, O = !1;
    Object.keys(p).forEach((D) => {
      D === y(this, Tt, "f") && p[D] ? b = !0 : D === y(this, St, "f") && p[D] && (O = !0);
    }), p.$0 = this.$0, this.parsed = g, s === 0 && y(this, tt, "f").clearCachedHelpMessage();
    try {
      if (this[We](), e)
        return this[Jt](p, a, !!n, !1);
      y(this, Tt, "f") && [y(this, Tt, "f")].concat(h[y(this, Tt, "f")] || []).filter((d) => d.length > 1).includes("" + p._[p._.length - 1]) && (p._.pop(), b = !0), V(this, Ce, !1, "f");
      const D = y(this, ct, "f").getCommands(), w = y(this, Ct, "f").completionKey in p, A = b || w || i;
      if (p._.length) {
        if (D.length) {
          let C;
          for (let d = s || 0, E; p._[d] !== void 0; d++)
            if (E = String(p._[d]), D.includes(E) && E !== y(this, wt, "f")) {
              const T = y(this, ct, "f").runCommand(E, this, g, d + 1, i, b || O || i);
              return this[Jt](T, a, !!n, !1);
            } else if (!C && E !== y(this, wt, "f")) {
              C = E;
              break;
            }
          !y(this, ct, "f").hasDefaultCommand() && y(this, Te, "f") && C && !A && y(this, ot, "f").recommendCommands(C, D);
        }
        y(this, wt, "f") && p._.includes(y(this, wt, "f")) && !w && (y(this, It, "f") && fe(!0), this.showCompletionScript(), this.exit(0));
      }
      if (y(this, ct, "f").hasDefaultCommand() && !A) {
        const C = y(this, ct, "f").runCommand(null, this, g, 0, i, b || O || i);
        return this[Jt](C, a, !!n, !1);
      }
      if (w) {
        y(this, It, "f") && fe(!0), t = [].concat(t);
        const C = t.slice(t.indexOf(`--${y(this, Ct, "f").completionKey}`) + 1);
        return y(this, Ct, "f").getCompletion(C, (d, E) => {
          if (d)
            throw new ut(d.message);
          (E || []).forEach((T) => {
            y(this, ne, "f").log(T);
          }), this.exit(0);
        }), this[Jt](p, !a, !!n, !1);
      }
      if (y(this, Ot, "f") || (b ? (y(this, It, "f") && fe(!0), r = !0, this.showHelp("log"), this.exit(0)) : O && (y(this, It, "f") && fe(!0), r = !0, y(this, tt, "f").showVersion("log"), this.exit(0))), !r && y(this, G, "f").skipValidation.length > 0 && (r = Object.keys(p).some((C) => y(this, G, "f").skipValidation.indexOf(C) >= 0 && p[C] === !0)), !r) {
        if (g.error)
      ...
      if (D instanceof ut)
        y(this, tt, "f").fail(D.message, D);
      else
        throw D;
    }
    return this[Jt](f ?? p, a, !!n, !0);
  }
  [Ke](t, e, n, s) {
    const i = { ...this.getDemandedOptions() };
    return (r) => {
      if (n)
        throw new ut(n.message);
      y(this, ot, "f").nonOptionCount(r), y(this, ot, "f").requiredArguments(r, i);
      let a = !1;
      y(this, kt, "f") && (a = y(this, ot, "f").unknownCommands(r)), y(this, Yt, "f") && !a ? y(this, ot, "f").unknownArguments(r, t, e, !!s) : y(this, Kt, "f") && y(this, ot, "f").unknownArguments(r, t, {}, !1, !1), y(this, ot, "f").limitedChoices(r), y(this, ot, "f").implications(r), y(this, ot, "f").conflicting(r);
    };
  }
  [Ri]() {
    V(this, Ot, !0, "f");
...
function Ut() {
  return Ui || (Ui = 1, function() {
    ...
    o = function() {
      var g, p, f, h, b, O;
      if (O = arguments[0], b = 2 <= arguments.length ? a.call(arguments, 1) : [], s(Object.assign))
      ...
      return !!g && Object.prototype.toString.call(g) === "[object Function]";
    }, i = function(g) {
      var p;
      return !!g && ((p = typeof g) == "function" || p === "object");
    }, e = function(g) {
      return s(Array.isArray) ? Array.isArray(g) : Object.prototype.toString.call(g) === "[object Array]";
    }, n = function(g) {
      var p;
      if (e(g))
        return !g.length;
      ...
      var p, f;
      return i(g) && (f = Object.getPrototypeOf(g)) && (p = f.constructor) && typeof p == "function" && p instanceof p && Function.prototype.toString.call(p) === Function.prototype.toString.call(Object);
    }, t = function(g) {
      return s(g.valueOf) ? g.valueOf() : g;
    }, Bt.assign = o, Bt.isFunction = s, Bt.isObject = i, Bt.isArray = e, Bt.isEmpty = n, Bt.isPlainObject = r, Bt.getValue = t;
  }.call(et)), Bt;
}
var Ze = { exports: {} }, Xi;
function Vr() {
  return Xi || (Xi = 1, function() {
    Ze.exports = function() {
      ...
      return o.prototype.hasFeature = function(t, e) {
        return !0;
      }, o.prototype.createDocumentType = function(t, e, n) {
        throw new Error("This DOM method is not implemented.");
      }, o.prototype.createDocument = function(t, e, n) {
        throw new Error("This DOM method is not implemented.");
      }, o.prototype.createHTMLDocument = function(t) {
        throw new Error("This DOM method is not implemented.");
      }, o.prototype.getFeature = function(t, e) {
        throw new Error("This DOM method is not implemented.");
      }, o;
    }();
  }.call(et)), Ze.exports;
}
var tn = { exports: {} }, en = { exports: {} }, nn = { exports: {} }, $i;
function No() {
  return $i || ($i = 1, function() {
    nn.exports = function() {
      function o() {
      }
      return o.prototype.handleError = function(t) {
        throw new Error(t);
      }, o;
    }();
  }.call(et)), nn.exports;
...
var qi;
function Ao() {
  return qi || (qi = 1, function() {
    var o, t;
    o = No(), t = Po(), en.exports = function() {
      function e() {
        this.defaultParams = {
          "canonical-form": !1,
          "cdata-sections": !1,
...
var sn = { exports: {} }, on = { exports: {} }, an = { exports: {} }, Vi;
function ft() {
  ...
  return Hi || (Hi = 1, function() {
    ...
    o = ft(), xt(), cn.exports = function() {
      function t(e, n, s) {
        ...
        this.name = this.stringify.name(n), this.value = this.stringify.attValue(s), this.type = o.Attribute, this.isId = !1, this.schemaTypeInfo = null;
      }
...
function Vn() {
  return zi || (zi = 1, function() {
    un.exports = function() {
      ...
      }, o.prototype.getNamedItem = function(t) {
        return this.nodes[t];
      }, o.prototype.setNamedItem = function(t) {
        var e;
        return e = this.nodes[t.nodeName], this.nodes[t.nodeName] = t, e || null;
      }, o.prototype.removeNamedItem = function(t) {
        var e;
        return e = this.nodes[t], delete this.nodes[t], e || null;
      }, o.prototype.item = function(t) {
        return this.nodes[Object.keys(this.nodes)[t]] || null;
      }, o.prototype.getNamedItemNS = function(t, e) {
        throw new Error("This DOM method is not implemented.");
      }, o.prototype.setNamedItemNS = function(t) {
        throw new Error("This DOM method is not implemented.");
      }, o.prototype.removeNamedItemNS = function(t, e) {
        throw new Error("This DOM method is not implemented.");
      }, o;
    }();
  }.call(et)), un.exports;
...
function Hn() {
  return Gi || (Gi = 1, function() {
    var o, t, e, n, s, i, r, a, c = function(p, f) {
      for (var h in f)
        g.call(f, h) && (p[h] = f[h]);
      function b() {
        this.constructor = p;
    ...
    a = Ut(), r = a.isObject, i = a.isFunction, s = a.getValue, n = xt(), o = ft(), t = Hr(), e = Vn(), on.exports = function(p) {
      ...
      function f(h, b, O) {
        var D, w, A, C;
        if (f.__super__.constructor.call(this, h), b == null)
          throw new Error("Missing element name. " + this.debugInfo());
        if (this.name = this.stringify.name(b), this.type = o.Element, this.attribs = {}, this.schemaTypeInfo = null, O != null && this.attribute(O), h.type === o.Document && (this.isRoot = !0, this.documentObject = h, h.rootObject = this, h.children)) {
          for (C = h.children, w = 0, A = C.length; w < A; w++)
            if (D = C[w], D.type === o.DocType) {
              D.name = this.name;
              break;
            }
        }
      ...
      return Object.defineProperty(f.prototype, "tagName", {
        ...
        var h, b, O, D;
        O = Object.create(this), O.isRoot && (O.documentObject = null), O.attribs = {}, D = this.attribs;
        for (b in D)
          g.call(D, b) && (h = D[b], O.attribs[b] = h.clone());
        return O.children = [], this.children.forEach(function(w) {
          var A;
          return A = w.clone(), A.parent = O, O.children.push(A);
        }), O;
      }, f.prototype.attribute = function(h, b) {
        var O, D;
        if (h != null && (h = s(h)), r(h))
          for (O in h)
            g.call(h, O) && (D = h[O], this.attribute(O, D));
        else
          i(b) && (b = b.apply()), this.options.keepNullAttributes && b == null ? this.attribs[h] = new t(this, h, "") : b != null && (this.attribs[h] = new t(this, h, b));
        return this;
      }, f.prototype.removeAttribute = function(h) {
        var b, O, D;
        if (h == null)
          throw new Error("Missing attribute name. " + this.debugInfo());
        if (h = s(h), Array.isArray(h))
          for (O = 0, D = h.length; O < D; O++)
            b = h[O], delete this.attribs[b];
        else
      ...
      }, f.prototype.att = function(h, b) {
        return this.attribute(h, b);
      }, f.prototype.a = function(h, b) {
        return this.attribute(h, b);
      }, f.prototype.getAttribute = function(h) {
        return this.attribs.hasOwnProperty(h) ? this.attribs[h].value : null;
      }, f.prototype.setAttribute = function(h, b) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.getAttributeNode = function(h) {
        return this.attribs.hasOwnProperty(h) ? this.attribs[h] : null;
      }, f.prototype.setAttributeNode = function(h) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.removeAttributeNode = function(h) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.getElementsByTagName = function(h) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.getAttributeNS = function(h, b) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.setAttributeNS = function(h, b, O) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.removeAttributeNS = function(h, b) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.getAttributeNodeNS = function(h, b) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.setAttributeNodeNS = function(h) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.getElementsByTagNameNS = function(h, b) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.hasAttribute = function(h) {
        return this.attribs.hasOwnProperty(h);
      }, f.prototype.hasAttributeNS = function(h, b) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.setIdAttribute = function(h, b) {
        return this.attribs.hasOwnProperty(h) ? this.attribs[h].isId : b;
      }, f.prototype.setIdAttributeNS = function(h, b, O) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.setIdAttributeNode = function(h, b) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.getElementsByTagName = function(h) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.getElementsByTagNameNS = function(h, b) {
        ...
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, f.prototype.isEqualNode = function(h) {
        var b, O, D;
        if (!f.__super__.isEqualNode.apply(this, arguments).isEqualNode(h) || h.namespaceURI !== this.namespaceURI || h.prefix !== this.prefix || h.localName !== this.localName || h.attribs.length !== this.attribs.length)
          return !1;
        for (b = O = 0, D = this.attribs.length - 1; 0 <= D ? O <= D : O >= D; b = 0 <= D ? ++O : --O)
...
var ln = { exports: {} }, fn = { exports: {} }, Yi;
function je() {
  return Yi || (Yi = 1, function() {
    var o, t = function(n, s) {
      for (var i in s)
        e.call(s, i) && (n[i] = s[i]);
      function r() {
        this.constructor = n;
    ...
    o = xt(), fn.exports = function(n) {
      ...
      return Object.defineProperty(s.prototype, "data", {
        ...
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, s.prototype.replaceData = function(i, r, a) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
...
function zn() {
  return ki || (ki = 1, function() {
    ...
    o = ft(), t = je(), ln.exports = function(s) {
      e(i, s);
      function i(r, a) {
        if (i.__super__.constructor.call(this, r), a == null)
          throw new Error("Missing CDATA text. " + this.debugInfo());
        this.name = "#cdata-section", this.type = o.CData, this.value = this.stringify.cdata(a);
      }
...
function Gn() {
  return Ki || (Ki = 1, function() {
    ...
    o = ft(), t = je(), hn.exports = function(s) {
      e(i, s);
      function i(r, a) {
        if (i.__super__.constructor.call(this, r), a == null)
          throw new Error("Missing comment text. " + this.debugInfo());
        this.name = "#comment", this.type = o.Comment, this.value = this.stringify.comment(a);
      }
      return i.prototype.clone = function() {
        return Object.create(this);
      }, i.prototype.toString = function(r) {
...
function Yn() {
  return Qi || (Qi = 1, function() {
    ...
    e = Ut().isObject, t = xt(), o = ft(), pn.exports = function(i) {
      ...
      function r(a, c, g, p) {
        var f;
        r.__super__.constructor.call(this, a), e(c) && (f = c, c = f.version, g = f.encoding, p = f.standalone), c || (c = "1.0"), this.type = o.Declaration, this.version = this.stringify.xmlVersion(c), g != null && (this.encoding = this.stringify.xmlEncoding(g)), p != null && (this.standalone = this.stringify.xmlStandalone(p));
      }
  ...
  return Ji || (Ji = 1, function() {
    ...
    t = xt(), o = ft(), mn.exports = function(s) {
      ...
      function i(r, a, c, g, p, f) {
        ...
        if (p.indexOf("#") !== 0 && (p = "#" + p), !p.match(/^(#REQUIRED|#IMPLIED|#FIXED|#DEFAULT)$/))
          throw new Error("Invalid default value type; expected: #REQUIRED, #IMPLIED, #FIXED or #DEFAULT. " + this.debugInfo(a));
        if (f && !p.match(/^(#FIXED|#DEFAULT)$/))
          throw new Error("Default value only applies to #FIXED or #DEFAULT. " + this.debugInfo(a));
        this.elementName = this.stringify.name(a), this.type = o.AttributeDeclaration, this.attributeName = this.stringify.name(c), this.attributeType = this.stringify.dtdAttType(g), f && (this.defaultValue = this.stringify.dtdAttDefault(f)), this.defaultValueType = p;
      }
    ...
    e = Ut().isObject, t = xt(), o = ft(), gn.exports = function(i) {
      ...
      function r(a, c, g, p) {
        if (r.__super__.constructor.call(this, a), g == null)
          throw new Error("Missing DTD entity name. " + this.debugInfo(g));
        if (p == null)
          throw new Error("Missing DTD entity value. " + this.debugInfo(g));
        if (this.pe = !!c, this.name = this.stringify.name(g), this.type = o.EntityDeclaration, !e(p))
          this.value = this.stringify.dtdEntityValue(p), this.internal = !0;
        else {
          if (!p.pubID && !p.sysID)
            throw new Error("Public and/or system identifiers are required for an external entity. " + this.debugInfo(g));
          if (p.pubID && !p.sysID)
            throw new Error("System identifier is required for a public external entity. " + this.debugInfo(g));
          if (this.internal = !1, p.pubID != null && (this.pubID = this.stringify.dtdPubID(p.pubID)), p.sysID != null && (this.sysID = this.stringify.dtdSysID(p.sysID)), p.nData != null && (this.nData = this.stringify.dtdNData(p.nData)), this.pe && this.nData)
            throw new Error("Notation declaration is not allowed in a parameter entity. " + this.debugInfo(g));
        }
      }
  ...
  return tr || (tr = 1, function() {
    ...
    t = xt(), o = ft(), yn.exports = function(s) {
      ...
      function i(r, a, c) {
        if (i.__super__.constructor.call(this, r), a == null)
          throw new Error("Missing DTD element name. " + this.debugInfo());
        c || (c = "(#PCDATA)"), Array.isArray(c) && (c = "(" + c.join(",") + ")"), this.name = this.stringify.name(a), this.type = o.ElementDeclaration, this.value = this.stringify.dtdElementValue(c);
      }
      return i.prototype.toString = function(r) {
  ...
  return er || (er = 1, function() {
    ...
    t = xt(), o = ft(), bn.exports = function(s) {
      ...
      function i(r, a, c) {
        ...
        this.name = this.stringify.name(a), this.type = o.NotationDeclaration, c.pubID != null && (this.pubID = this.stringify.dtdPubID(c.pubID)), c.sysID != null && (this.sysID = this.stringify.dtdSysID(c.sysID));
      }
...
function Zn() {
  return nr || (nr = 1, function() {
    ...
    a = Ut().isObject, r = xt(), o = ft(), t = kn(), n = Kn(), e = Qn(), s = Jn(), i = Vn(), dn.exports = function(p) {
      ...
      function f(h, b, O) {
        var D, w, A, C, d, E;
        if (f.__super__.constructor.call(this, h), this.type = o.DocType, h.children) {
          for (C = h.children, w = 0, A = C.length; w < A; w++)
            if (D = C[w], D.type === o.Element) {
              this.name = D.name;
              break;
            }
        }
        this.documentObject = h, a(b) && (d = b, b = d.pubID, O = d.sysID), O == null && (E = [b, O], O = E[0], b = E[1]), b != null && (this.pubID = this.stringify.dtdPubID(b)), O != null && (this.sysID = this.stringify.dtdSysID(O));
      }
      return Object.defineProperty(f.prototype, "entities", {
        get: function() {
          var h, b, O, D, w;
          for (D = {}, w = this.children, b = 0, O = w.length; b < O; b++)
            h = w[b], h.type === o.EntityDeclaration && !h.pe && (D[h.name] = h);
          return new i(D);
        }
        ...
        get: function() {
          var h, b, O, D, w;
          for (D = {}, w = this.children, b = 0, O = w.length; b < O; b++)
            h = w[b], h.type === o.NotationDeclaration && (D[h.name] = h);
          return new i(D);
        }
      ...
      }), f.prototype.element = function(h, b) {
        var O;
        return O = new e(this, h, b), this.children.push(O), this;
      }, f.prototype.attList = function(h, b, O, D, w) {
        var A;
        return A = new t(this, h, b, O, D, w), this.children.push(A), this;
      }, f.prototype.entity = function(h, b) {
        var O;
        return O = new n(this, !1, h, b), this.children.push(O), this;
      }, f.prototype.pEntity = function(h, b) {
        var O;
        return O = new n(this, !0, h, b), this.children.push(O), this;
      }, f.prototype.notation = function(h, b) {
        var O;
        return O = new s(this, h, b), this.children.push(O), this;
      }, f.prototype.toString = function(h) {
        return this.options.writer.docType(this, this.options.writer.filterOptions(h));
      }, f.prototype.ele = function(h, b) {
        return this.element(h, b);
      }, f.prototype.att = function(h, b, O, D, w) {
        return this.attList(h, b, O, D, w);
      }, f.prototype.ent = function(h, b) {
        return this.entity(h, b);
      }, f.prototype.pent = function(h, b) {
        return this.pEntity(h, b);
      }, f.prototype.not = function(h, b) {
        return this.notation(h, b);
      }, f.prototype.up = function() {
        return this.root() || this.documentObject;
      }, f.prototype.isEqualNode = function(h) {
        return !(!f.__super__.isEqualNode.apply(this, arguments).isEqualNode(h) || h.name !== this.name || h.publicId !== this.publicId || h.systemId !== this.systemId);
      }, f;
    }(r);
  }.call(et)), dn.exports;
}
  ...
  return ir || (ir = 1, function() {
    ...
    o = ft(), t = xt(), wn.exports = function(s) {
      ...
      function i(r, a) {
        ...
        this.type = o.Raw, this.value = this.stringify.raw(a);
      }
      return i.prototype.clone = function() {
        return Object.create(this);
      }, i.prototype.toString = function(r) {
...
function ei() {
  return rr || (rr = 1, function() {
    ...
    o = ft(), t = je(), On.exports = function(s) {
      e(i, s);
      function i(r, a) {
        if (i.__super__.constructor.call(this, r), a == null)
          throw new Error("Missing element text. " + this.debugInfo());
        this.name = "#text", this.type = o.Text, this.value = this.stringify.text(a);
      }
      return Object.defineProperty(i.prototype, "isElementContentWhitespace", {
        ...
        get: function() {
          ...
          for (c += this.data, r = this.nextSibling; r; )
            c = c + r.data, r = r.nextSibling;
          return c;
        }
...
function ni() {
  return sr || (sr = 1, function() {
    ...
    o = ft(), t = je(), En.exports = function(s) {
      e(i, s);
      function i(r, a, c) {
        if (i.__super__.constructor.call(this, r), a == null)
          throw new Error("Missing instruction target. " + this.debugInfo());
        this.type = o.ProcessingInstruction, this.target = this.stringify.insTarget(a), this.name = this.target, c && (this.value = this.stringify.insValue(c));
      }
      return i.prototype.clone = function() {
        return Object.create(this);
      }, i.prototype.toString = function(r) {
...
function xt() {
  return ur || (ur = 1, function() {
    ...
    w = Ut(), D = w.isObject, O = w.isFunction, b = w.isEmpty, h = w.getValue, a = null, e = null, n = null, s = null, i = null, p = null, f = null, g = null, r = null, t = null, c = null, o = null, sn.exports = function() {
      function C(d) {
        this.parent = d, this.parent && (this.options = this.parent.options, this.stringify = this.parent.stringify), this.value = null, this.children = [], this.baseURI = null, a || (a = Hn(), e = zn(), n = Gn(), s = Yn(), i = Zn(), p = ti(), f = ei(), g = ni(), r = zr(), t = ft(), c = Mo(), Vn(), o = Lo());
      }
      return Object.defineProperty(C.prototype, "nodeName", {
        ...
        get: function() {
          ...
          if (this.nodeType === t.Element || this.nodeType === t.DocumentFragment) {
            for (U = "", F = this.children, E = 0, T = F.length; E < T; E++)
              d = F[E], d.textContent && (U += d.textContent);
            return U;
          } else
            return null;
        },
        ...
        var E, T, F, U, j;
        for (this.parent = d, d && (this.options = d.options, this.stringify = d.stringify), U = this.children, j = [], T = 0, F = U.length; T < F; T++)
        ...
        if (N = null, E === null && T == null && (X = [{}, null], E = X[0], T = X[1]), E == null && (E = {}), E = h(E), D(E) || (Y = [E, T], T = Y[0], E = Y[1]), d != null && (d = h(d)), Array.isArray(d))
          ...
          for (M in d)
            if (A.call(d, M))
              if (k = d[M], O(k) && (k = k.apply()), !this.options.ignoreDecorators && this.stringify.convertAttKey && M.indexOf(this.stringify.convertAttKey) === 0)
                N = this.attribute(M.substr(this.stringify.convertAttKey.length), k);
              else if (!this.options.separateArrayItems && Array.isArray(k) && b(k))
                N = this.dummy();
              else if (D(k) && b(k))
                N = this.element(M);
      ...
      }, C.prototype.insertAfter = function(d, E, T) {
        var F, U, j;
        if (this.isRoot)
          throw new Error("Cannot insert elements at root level. " + this.debugInfo(d));
        return U = this.parent.children.indexOf(this), j = this.parent.children.splice(U + 1), F = this.parent.element(d, E, T), Array.prototype.push.apply(this.parent.children, j), F;
      }, C.prototype.remove = function() {
        var d;
        if (this.isRoot)
          throw new Error("Cannot remove the root element. " + this.debugInfo());
        return d = this.parent.children.indexOf(this), [].splice.apply(this.parent.children, [d, d - d + 1].concat([])), this.parent;
      }, C.prototype.node = function(d, E, T) {
        var F, U;
        return d != null && (d = h(d)), E || (E = {}), E = h(E), D(E) || (U = [E, T], T = U[0], E = U[1]), F = new a(this, d, E), T != null && F.text(T), this.children.push(F), F;
      }, C.prototype.text = function(d) {
        var E;
        return D(d) && this.element(d), E = new f(this, d), this.children.push(E), this;
      }, C.prototype.cdata = function(d) {
        var E;
        return E = new e(this, d), this.children.push(E), this;
      }, C.prototype.comment = function(d) {
        var E;
        return E = new n(this, d), this.children.push(E), this;
      }, C.prototype.commentBefore = function(d) {
        var E, T;
        return E = this.parent.children.indexOf(this), T = this.parent.children.splice(E), this.parent.comment(d), Array.prototype.push.apply(this.parent.children, T), this;
      }, C.prototype.commentAfter = function(d) {
        var E, T;
        return E = this.parent.children.indexOf(this), T = this.parent.children.splice(E + 1), this.parent.comment(d), Array.prototype.push.apply(this.parent.children, T), this;
      }, C.prototype.raw = function(d) {
        var E;
        return E = new p(this, d), this.children.push(E), this;
        ...
        if (d != null && (d = h(d)), E != null && (E = h(E)), Array.isArray(d))
          ...
          for (T in d)
            A.call(d, T) && (F = d[T], this.instruction(T, F));
        else
          O(E) && (E = E.apply()), U = new g(this, d, E), this.children.push(U);
        return this;
      }, C.prototype.instructionBefore = function(d, E) {
        var T, F;
        return T = this.parent.children.indexOf(this), F = this.parent.children.splice(T), this.parent.instruction(d, E), Array.prototype.push.apply(this.parent.children, F), this;
      }, C.prototype.instructionAfter = function(d, E) {
        var T, F;
        return T = this.parent.children.indexOf(this), F = this.parent.children.splice(T + 1), this.parent.instruction(d, E), Array.prototype.push.apply(this.parent.children, F), this;
      }, C.prototype.declaration = function(d, E, T) {
        var F, U;
        ...
        for (X = F.children, j = M = 0, L = X.length; M < L; j = ++M)
          if (T = X[j], T.isRoot)
            return F.children.splice(j, 0, U), U;
        return F.children.push(U), U;
        ...
        var E;
        return E = d.root().clone(), E.parent = this, E.isRoot = !1, this.children.push(E), this;
      }, C.prototype.debugInfo = function(d) {
        var E, T;
        return d = d || this.name, d == null && !((E = this.parent) != null && E.name) ? "" : d == null ? "parent: <" + this.parent.name + ">" : (T = this.parent) != null && T.name ? "node: <" + d + ">, parent: <" + this.parent.name + ">" : "node: <" + d + ">";
      }, C.prototype.ele = function(d, E, T) {
        return this.element(d, E, T);
      }, C.prototype.nod = function(d, E, T) {
        return this.node(d, E, T);
      ...
      }, C.prototype.ins = function(d, E) {
        return this.instruction(d, E);
      }, C.prototype.doc = function() {
        return this.document();
      }, C.prototype.dec = function(d, E, T) {
        return this.declaration(d, E, T);
      }, C.prototype.e = function(d, E, T) {
        return this.element(d, E, T);
      }, C.prototype.n = function(d, E, T) {
        return this.node(d, E, T);
        ...
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, C.prototype.isSupported = function(d, E) {
        return !0;
      }, C.prototype.hasAttributes = function() {
        return this.attribs.length !== 0;
      }, C.prototype.compareDocumentPosition = function(d) {
        var E, T;
        return E = this, E === d ? 0 : this.document() !== d.document() ? (T = o.Disconnected | o.ImplementationSpecific, Math.random() < 0.5 ? T |= o.Preceding : T |= o.Following, T) : E.isAncestor(d) ? o.Contains | o.Preceding : E.isDescendant(d) ? o.Contains | o.Following : E.isPreceding(d) ? o.Preceding : o.Following;
        ...
        if (d.nodeType !== this.nodeType || d.children.length !== this.children.length)
          return !1;
        for (E = T = 0, F = this.children.length - 1; 0 <= F ? T <= F : T >= F; E = 0 <= F ? ++T : --T)
          if (!this.children[E].isEqualNode(d.children[E]))
            return !1;
        return !0;
      }, C.prototype.getFeature = function(d, E) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, C.prototype.setUserData = function(d, E, T) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
        ...
        var E, T, F, U, j;
        for (j = this.children, F = 0, U = j.length; F < U; F++)
          if (E = j[F], d === E || (T = E.isDescendant(d), T))
            return !0;
        return !1;
        ...
        var E, T;
        return E = this.treePosition(d), T = this.treePosition(this), E === -1 || T === -1 ? !1 : E < T;
      }, C.prototype.isFollowing = function(d) {
        var E, T;
        return E = this.treePosition(d), T = this.treePosition(this), E === -1 || T === -1 ? !1 : E > T;
      }, C.prototype.treePosition = function(d) {
        var E, T;
        return T = 0, E = !1, this.foreachTreeNode(this.document(), function(F) {
          if (T++, !E && F === d)
            return E = !0;
        }), E ? T : -1;
...
function Gr() {
  return lr || (lr = 1, function() {
    ...
    _n.exports = function() {
      function e(n) {
        this.assertLegalName = o(this.assertLegalName, this), this.assertLegalChar = o(this.assertLegalChar, this);
        var s, i, r;
...
`, r.offset = (g = i.offset) != null ? g : 0, r.dontPrettyTextNodes = (p = (f = i.dontPrettyTextNodes) != null ? f : i.dontprettytextnodes) != null ? p : 0, r.spaceBeforeSlash = (h = (b = i.spaceBeforeSlash) != null ? b : i.spacebeforeslash) != null ? h : "", r.spaceBeforeSlash === !0 && (r.spaceBeforeSlash = " "), r.suppressPrettyCount = 0, r.user = {}, r.state = t.None, r;
      ...
      }, s.prototype.endline = function(i, r, a) {
        return !r.pretty || r.suppressPrettyCount ? "" : r.newline;
      }, s.prototype.attribute = function(i, r, a) {
        var c;
        return this.openAttribute(i, r, a), c = " " + i.name + '="' + i.value + '"', this.closeAttribute(i, r, a), c;
      }, s.prototype.cdata = function(i, r, a) {
        var c;
        return this.openNode(i, r, a), r.state = t.OpenTag, c = this.indent(i, r, a) + "<![CDATA[", r.state = t.InsideTag, c += i.value, r.state = t.CloseTag, c += "]]>" + this.endline(i, r, a), r.state = t.None, this.closeNode(i, r, a), c;
      }, s.prototype.comment = function(i, r, a) {
        var c;
        return this.openNode(i, r, a), r.state = t.OpenTag, c = this.indent(i, r, a) + "<!-- ", r.state = t.InsideTag, c += i.value, r.state = t.CloseTag, c += " -->" + this.endline(i, r, a), r.state = t.None, this.closeNode(i, r, a), c;
      }, s.prototype.declaration = function(i, r, a) {
        var c;
        return this.openNode(i, r, a), r.state = t.OpenTag, c = this.indent(i, r, a) + "<?xml", r.state = t.InsideTag, c += ' version="' + i.version + '"', i.encoding != null && (c += ' encoding="' + i.encoding + '"'), i.standalone != null && (c += ' standalone="' + i.standalone + '"'), r.state = t.CloseTag, c += r.spaceBeforeSlash + "?>", c += this.endline(i, r, a), r.state = t.None, this.closeNode(i, r, a), c;
      }, s.prototype.docType = function(i, r, a) {
        var c, g, p, f, h;
        if (a || (a = 0), this.openNode(i, r, a), r.state = t.OpenTag, f = this.indent(i, r, a), f += "<!DOCTYPE " + i.root().name, i.pubID && i.sysID ? f += ' PUBLIC "' + i.pubID + '" "' + i.sysID + '"' : i.sysID && (f += ' SYSTEM "' + i.sysID + '"'), i.children.length > 0) {
          for (f += " [", f += this.endline(i, r, a), r.state = t.InsideTag, h = i.children, g = 0, p = h.length; g < p; g++)
            c = h[g], f += this.writeChildNode(c, r, a + 1);
          r.state = t.CloseTag, f += "]";
        }
        return r.state = t.CloseTag, f += r.spaceBeforeSlash + ">", f += this.endline(i, r, a), r.state = t.None, this.closeNode(i, r, a), f;
      }, s.prototype.element = function(i, r, a) {
        var c, g, p, f, h, b, O, D, w, A, C, d, E, T;
        a || (a = 0), A = !1, C = "", this.openNode(i, r, a), r.state = t.OpenTag, C += this.indent(i, r, a) + "<" + i.name, d = i.attribs;
        for (w in d)
          n.call(d, w) && (c = d[w], C += this.attribute(c, r, a));
        if (p = i.children.length, f = p === 0 ? null : i.children[0], p === 0 || i.children.every(function(F) {
          return (F.type === o.Text || F.type === o.Raw) && F.value === "";
        }))
          r.allowEmpty ? (C += ">", r.state = t.CloseTag, C += "</" + i.name + ">" + this.endline(i, r, a)) : (r.state = t.CloseTag, C += r.spaceBeforeSlash + "/>" + this.endline(i, r, a));
        else if (r.pretty && p === 1 && (f.type === o.Text || f.type === o.Raw) && f.value != null)
          C += ">", r.state = t.InsideTag, r.suppressPrettyCount++, A = !0, C += this.writeChildNode(f, r, a + 1), r.suppressPrettyCount--, A = !1, r.state = t.CloseTag, C += "</" + i.name + ">" + this.endline(i, r, a);
        else {
          if (r.dontPrettyTextNodes) {
            for (E = i.children, h = 0, O = E.length; h < O; h++)
              if (g = E[h], (g.type === o.Text || g.type === o.Raw) && g.value != null) {
                r.suppressPrettyCount++, A = !0;
                break;
              }
          }
          for (C += ">" + this.endline(i, r, a), r.state = t.InsideTag, T = i.children, b = 0, D = T.length; b < D; b++)
            g = T[b], C += this.writeChildNode(g, r, a + 1);
          r.state = t.CloseTag, C += this.indent(i, r, a) + "</" + i.name + ">", A && r.suppressPrettyCount--, C += this.endline(i, r, a), r.state = t.None;
        }
        return this.closeNode(i, r, a), C;
      }, s.prototype.writeChildNode = function(i, r, a) {
        switch (i.type) {
          case o.CData:
            return this.cdata(i, r, a);
          case o.Comment:
            return this.comment(i, r, a);
          case o.Element:
            return this.element(i, r, a);
          case o.Raw:
            return this.raw(i, r, a);
          case o.Text:
            return this.text(i, r, a);
          case o.ProcessingInstruction:
            return this.processingInstruction(i, r, a);
          case o.Dummy:
            return "";
          case o.Declaration:
            return this.declaration(i, r, a);
          case o.DocType:
            return this.docType(i, r, a);
          case o.AttributeDeclaration:
            return this.dtdAttList(i, r, a);
          case o.ElementDeclaration:
            return this.dtdElement(i, r, a);
          case o.EntityDeclaration:
            return this.dtdEntity(i, r, a);
          case o.NotationDeclaration:
            return this.dtdNotation(i, r, a);
          default:
            throw new Error("Unknown XML node type: " + i.constructor.name);
        }
      }, s.prototype.processingInstruction = function(i, r, a) {
        var c;
        return this.openNode(i, r, a), r.state = t.OpenTag, c = this.indent(i, r, a) + "<?", r.state = t.InsideTag, c += i.target, i.value && (c += " " + i.value), r.state = t.CloseTag, c += r.spaceBeforeSlash + "?>", c += this.endline(i, r, a), r.state = t.None, this.closeNode(i, r, a), c;
      }, s.prototype.raw = function(i, r, a) {
        var c;
        return this.openNode(i, r, a), r.state = t.OpenTag, c = this.indent(i, r, a), r.state = t.InsideTag, c += i.value, r.state = t.CloseTag, c += this.endline(i, r, a), r.state = t.None, this.closeNode(i, r, a), c;
      }, s.prototype.text = function(i, r, a) {
        var c;
        return this.openNode(i, r, a), r.state = t.OpenTag, c = this.indent(i, r, a), r.state = t.InsideTag, c += i.value, r.state = t.CloseTag, c += this.endline(i, r, a), r.state = t.None, this.closeNode(i, r, a), c;
      }, s.prototype.dtdAttList = function(i, r, a) {
        var c;
        return this.openNode(i, r, a), r.state = t.OpenTag, c = this.indent(i, r, a) + "<!ATTLIST", r.state = t.InsideTag, c += " " + i.elementName + " " + i.attributeName + " " + i.attributeType, i.defaultValueType !== "#DEFAULT" && (c += " " + i.defaultValueType), i.defaultValue && (c += ' "' + i.defaultValue + '"'), r.state = t.CloseTag, c += r.spaceBeforeSlash + ">" + this.endline(i, r, a), r.state = t.None, this.closeNode(i, r, a), c;
      }, s.prototype.dtdElement = function(i, r, a) {
        var c;
        return this.openNode(i, r, a), r.state = t.OpenTag, c = this.indent(i, r, a) + "<!ELEMENT", r.state = t.InsideTag, c += " " + i.name + " " + i.value, r.state = t.CloseTag, c += r.spaceBeforeSlash + ">" + this.endline(i, r, a), r.state = t.None, this.closeNode(i, r, a), c;
      }, s.prototype.dtdEntity = function(i, r, a) {
        var c;
        return this.openNode(i, r, a), r.state = t.OpenTag, c = this.indent(i, r, a) + "<!ENTITY", r.state = t.InsideTag, i.pe && (c += " %"), c += " " + i.name, i.value ? c += ' "' + i.value + '"' : (i.pubID && i.sysID ? c += ' PUBLIC "' + i.pubID + '" "' + i.sysID + '"' : i.sysID && (c += ' SYSTEM "' + i.sysID + '"'), i.nData && (c += " NDATA " + i.nData)), r.state = t.CloseTag, c += r.spaceBeforeSlash + ">" + this.endline(i, r, a), r.state = t.None, this.closeNode(i, r, a), c;
      }, s.prototype.dtdNotation = function(i, r, a) {
        var c;
        return this.openNode(i, r, a), r.state = t.OpenTag, c = this.indent(i, r, a) + "<!NOTATION", r.state = t.InsideTag, c += " " + i.name, i.pubID && i.sysID ? c += ' PUBLIC "' + i.pubID + '" "' + i.sysID + '"' : i.pubID ? c += ' PUBLIC "' + i.pubID + '"' : i.sysID && (c += ' SYSTEM "' + i.sysID + '"'), r.state = t.CloseTag, c += r.spaceBeforeSlash + ">" + this.endline(i, r, a), r.state = t.None, this.closeNode(i, r, a), c;
      }, s.prototype.openNode = function(i, r, a) {
      }, s.prototype.closeNode = function(i, r, a) {
      }, s.prototype.openAttribute = function(i, r, a) {
  ...
  return pr || (pr = 1, function() {
    ...
    o = Yr(), Tn.exports = function(n) {
      ...
      return s.prototype.document = function(i, r) {
        var a, c, g, p, f;
        for (r = this.filterOptions(r), p = "", f = i.children, c = 0, g = f.length; c < g; c++)
          a = f[c], p += this.writeChildNode(a, r, 0);
        return r.pretty && p.slice(-r.newline.length) === r.newline && (p = p.slice(0, -r.newline.length)), p;
      }, s;
    }(o);
  }.call(et)), Tn.exports;
}
...
function kr() {
  return dr || (dr = 1, function() {
    var o, t, e, n, s, i, r, a = function(g, p) {
      for (var f in p)
        c.call(p, f) && (g[f] = p[f]);
      function h() {
        this.constructor = g;
    ...
    r = Ut().isPlainObject, e = Vr(), t = Ao(), n = xt(), o = ft(), i = Gr(), s = ii(), tn.exports = function(g) {
      ...
      return Object.defineProperty(p.prototype, "implementation", {
        value: new e()
      }), Object.defineProperty(p.prototype, "doctype", {
        get: function() {
          var f, h, b, O;
          for (O = this.children, h = 0, b = O.length; h < b; h++)
            if (f = O[h], f.type === o.DocType)
              return f;
          return null;
        }
      }), Object.defineProperty(p.prototype, "documentElement", {
        get: function() {
          return this.rootObject || null;
        }
      }), Object.defineProperty(p.prototype, "inputEncoding", {
        get: function() {
          return null;
        }
        ...
        get: function() {
          return this.children.length !== 0 && this.children[0].type === o.Declaration ? this.children[0].encoding : null;
        }
      }), Object.defineProperty(p.prototype, "xmlStandalone", {
        get: function() {
          return this.children.length !== 0 && this.children[0].type === o.Declaration ? this.children[0].standalone === "yes" : !1;
        }
      }), Object.defineProperty(p.prototype, "xmlVersion", {
        get: function() {
          return this.children.length !== 0 && this.children[0].type === o.Declaration ? this.children[0].version : "1.0";
        }
      ...
      }), Object.defineProperty(p.prototype, "compatMode", {
        get: function() {
          return null;
        }
      }), Object.defineProperty(p.prototype, "characterSet", {
        get: function() {
          return null;
        }
      }), Object.defineProperty(p.prototype, "contentType", {
        get: function() {
          return null;
        }
      }), p.prototype.end = function(f) {
        var h;
        return h = {}, f ? r(f) && (h = f, f = this.options.writer) : f = this.options.writer, f.document(this, f.filterOptions(h));
      }, p.prototype.toString = function(f) {
        return this.options.writer.document(this, this.options.writer.filterOptions(f));
      }, p.prototype.createElement = function(f) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.createDocumentFragment = function() {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.createTextNode = function(f) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.createComment = function(f) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.createCDATASection = function(f) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.createProcessingInstruction = function(f, h) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.createAttribute = function(f) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.createEntityReference = function(f) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.getElementsByTagName = function(f) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.importNode = function(f, h) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.createElementNS = function(f, h) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.createAttributeNS = function(f, h) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.getElementsByTagNameNS = function(f, h) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.getElementById = function(f) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.adoptNode = function(f) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.normalizeDocument = function() {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.renameNode = function(f, h, b) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.getElementsByClassName = function(f) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.createEvent = function(f) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.createRange = function() {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.createNodeIterator = function(f, h, b) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p.prototype.createTreeWalker = function(f, h, b) {
        throw new Error("This DOM method is not implemented." + this.debugInfo());
      }, p;
    }(n);
  }.call(et)), tn.exports;
...
function jo() {
  return gr || (gr = 1, function() {
    ...
    o = ft(), e = Yr(), t = Fe(), Pn.exports = function(i) {
      n(r, i);
      function r(a, c) {
        this.stream = a, r.__super__.constructor.call(this, c);
      }
      return r.prototype.endline = function(a, c, g) {
        return a.isLastRootNode && c.state === t.CloseTag ? "" : r.__super__.endline.call(this, a, c, g);
      }, r.prototype.document = function(a, c) {
        var g, p, f, h, b, O, D, w, A;
        for (D = a.children, p = f = 0, b = D.length; f < b; p = ++f)
          g = D[p], g.isLastRootNode = p === a.children.length - 1;
        for (c = this.filterOptions(c), w = a.children, A = [], h = 0, O = w.length; h < O; h++)
          g = w[h], A.push(this.writeChildNode(g, c, 0));
        return A;
      }, r.prototype.attribute = function(a, c, g) {
        return this.stream.write(r.__super__.attribute.call(this, a, c, g));
      }, r.prototype.cdata = function(a, c, g) {
        return this.stream.write(r.__super__.cdata.call(this, a, c, g));
      }, r.prototype.comment = function(a, c, g) {
        return this.stream.write(r.__super__.comment.call(this, a, c, g));
      }, r.prototype.declaration = function(a, c, g) {
        return this.stream.write(r.__super__.declaration.call(this, a, c, g));
      }, r.prototype.docType = function(a, c, g) {
        var p, f, h, b;
        if (g || (g = 0), this.openNode(a, c, g), c.state = t.OpenTag, this.stream.write(this.indent(a, c, g)), this.stream.write("<!DOCTYPE " + a.root().name), a.pubID && a.sysID ? this.stream.write(' PUBLIC "' + a.pubID + '" "' + a.sysID + '"') : a.sysID && this.stream.write(' SYSTEM "' + a.sysID + '"'), a.children.length > 0) {
          for (this.stream.write(" ["), this.stream.write(this.endline(a, c, g)), c.state = t.InsideTag, b = a.children, f = 0, h = b.length; f < h; f++)
            p = b[f], this.writeChildNode(p, c, g + 1);
          c.state = t.CloseTag, this.stream.write("]");
        }
        return c.state = t.CloseTag, this.stream.write(c.spaceBeforeSlash + ">"), this.stream.write(this.endline(a, c, g)), c.state = t.None, this.closeNode(a, c, g);
      }, r.prototype.element = function(a, c, g) {
        var p, f, h, b, O, D, w, A, C;
        g || (g = 0), this.openNode(a, c, g), c.state = t.OpenTag, this.stream.write(this.indent(a, c, g) + "<" + a.name), A = a.attribs;
        for (w in A)
          s.call(A, w) && (p = A[w], this.attribute(p, c, g));
        if (h = a.children.length, b = h === 0 ? null : a.children[0], h === 0 || a.children.every(function(d) {
          ...
          this.stream.write(">"), c.state = t.InsideTag, c.suppressPrettyCount++, this.writeChildNode(b, c, g + 1), c.suppressPrettyCount--, c.state = t.CloseTag, this.stream.write("</" + a.name + ">");
        else {
          for (this.stream.write(">" + this.endline(a, c, g)), c.state = t.InsideTag, C = a.children, O = 0, D = C.length; O < D; O++)
            f = C[O], this.writeChildNode(f, c, g + 1);
          c.state = t.CloseTag, this.stream.write(this.indent(a, c, g) + "</" + a.name + ">");
        }
        return this.stream.write(this.endline(a, c, g)), c.state = t.None, this.closeNode(a, c, g);
      }, r.prototype.processingInstruction = function(a, c, g) {
        return this.stream.write(r.__super__.processingInstruction.call(this, a, c, g));
      }, r.prototype.raw = function(a, c, g) {
        return this.stream.write(r.__super__.raw.call(this, a, c, g));
      }, r.prototype.text = function(a, c, g) {
        return this.stream.write(r.__super__.text.call(this, a, c, g));
      }, r.prototype.dtdAttList = function(a, c, g) {
        return this.stream.write(r.__super__.dtdAttList.call(this, a, c, g));
      }, r.prototype.dtdElement = function(a, c, g) {
        return this.stream.write(r.__super__.dtdElement.call(this, a, c, g));
      }, r.prototype.dtdEntity = function(a, c, g) {
        return this.stream.write(r.__super__.dtdEntity.call(this, a, c, g));
      }, r.prototype.dtdNotation = function(a, c, g) {
        return this.stream.write(r.__super__.dtdNotation.call(this, a, c, g));
      }, r;
    }(e);
  }.call(et)), Pn.exports;
}
...
function Fo() {
  return yr || (yr = 1, function() {
    var o, t, e, n, s, i, r, a, c, g;
    g = Ut(), a = g.assign, c = g.isFunction, e = Vr(), n = kr(), s = So(), r = ii(), i = jo(), o = ft(), t = Fe(), Rt.create = function(p, f, h, b) {
      var O, D;
      if (p == null)
        throw new Error("Root element needs a name.");
      return b = a({}, f, h, b), O = new n(b), D = O.element(p), b.headless || (O.declaration(b), (b.pubID != null || b.sysID != null) && O.dtd(b)), D;
    }, Rt.begin = function(p, f, h) {
      var b;
      return c(p) && (b = [p, f], f = b[0], h = b[1], p = {}), f ? new s(p, f, h) : new n(p);
    }, Rt.stringWriter = function(p) {
      return new r(p);
    }, Rt.streamWriter = function(p, f) {
      return new i(p, f);
    }, Rt.implementation = new e(), Rt.nodeType = o, Rt.writerState = t;
  }.call(et)), Rt;
}
var br;
function Ro() {
  return br || (br = 1, function() {
    var o, t, e, n, s, i = {}.hasOwnProperty;
    o = Fo(), t = qn().defaults, n = function(r) {
      ...
      function r(a) {
        var c, g, p;
        this.options = {}, g = t["0.2"];
        for (c in g)
          i.call(g, c) && (p = g[c], this.options[c] = p);
        for (c in a)
          i.call(a, c) && (p = a[c], this.options[c] = p);
      }
      return r.prototype.buildObject = function(a) {
        var c, g, p, f, h;
        return c = this.options.attrkey, g = this.options.charkey, Object.keys(a).length === 1 && this.options.rootName === t["0.2"].rootName ? (h = Object.keys(a)[0], a = a[h]) : h = this.options.rootName, p = /* @__PURE__ */ function(b) {
          return function(O, D) {
            var w, A, C, d, E, T;
            if (typeof D != "object")
              b.options.cdata && n(D) ? O.raw(s(D)) : O.txt(D);
            else if (Array.isArray(D)) {
              for (d in D)
                if (i.call(D, d)) {
                  A = D[d];
                  for (E in A)
                    C = A[E], O = p(O.ele(E), C).up();
                }
            } else
              for (E in D)
                if (i.call(D, E))
                  if (A = D[E], E === c) {
                    ...
                    b.options.cdata && n(A) ? O = O.raw(s(A)) : O = O.txt(A);
                  else if (Array.isArray(A))
                    for (d in A)
                      i.call(A, d) && (C = A[d], typeof C == "string" ? b.options.cdata && n(C) ? O = O.ele(E).raw(s(C)).up() : O = O.ele(E, C).up() : O = p(O.ele(E), C).up());
                  else typeof A == "object" ? O = p(O.ele(E), A).up() : typeof A == "string" && b.options.cdata && n(A) ? O = O.ele(E).raw(s(A)).up() : (A == null && (A = ""), O = O.ele(E, A.toString()).up());
            return O;
          };
        }(this), f = o.create(h, this.options.xmldec, this.options.doctype, {
          headless: this.options.headless,
          allowSurrogateChars: this.options.allowSurrogateChars
        }), p(f, a).end(this.options.renderOpts);
      }, r;
    }();
  }.call(et)), Je;
}
    ...
    (function(t) {
          ...
          if (nt > l)
            switch (e[_]) {
              case "textNode":
                ...
                break;
              case "cdata":
                L(m, "oncdata", m.cdata), m.cdata = "";
                break;
              case "script":
                L(m, "onscript", m.script), m.script = "";
                break;
              default:
                Y(m, "Max buffer length exceeded: " + e[_]);
            }
          P = Math.max(P, nt);
        }
        var it = t.MAX_BUFFER_LENGTH - P;
      ...
      function p(m, l) {
        ...
        this._parser.onend = function() {
          ...
          P.emit("error", _), P._parser.error = null;
        }, this._decoder = null, c.forEach(function(_) {
          Object.defineProperty(P, "on" + _, {
            get: function() {
              return P._parser["on" + _];
            },
            set: function(J) {
              if (!J)
                return P.removeAllListeners(_), P._parser["on" + _] = J, J;
              P.on(_, J);
            },
            enumerable: !0,
            configurable: !1
...
Actual: ` + m.attribValue
            ...
            else if (_ === "xmlns" && m.attribValue !== O)
              W(
                m,
...
Actual: ` + m.attribValue
              ...
              var J = m.tag, nt = m.tags[m.tags.length - 1] || m;
              J.ns === nt.ns && (J.ns = Object.create(nt.ns)), J.ns[_] = m.attribValue;
            }
          m.attribList.push([m.attribName, m.attribValue]);
        } else
          m.tag.attributes[m.attribName] = m.attribValue, L(m, "onattribute", {
            name: m.attribName,
            value: m.attribValue
          });
        m.attribName = m.attribValue = "";
      ...
      function mt(m, l) {
        if (m.opt.xmlns) {
          ...
          P.ns && J.ns !== P.ns && Object.keys(P.ns).forEach(function(z) {
            L(m, "onopennamespace", {
              prefix: z,
              uri: P.ns[z]
            });
          ...
          for (var nt = 0, it = m.attribList.length; nt < it; nt++) {
            ...
            S && S !== "xmlns" && !q && (W(
              m,
              "Unbound namespace prefix: " + JSON.stringify(S)
            ), $.uri = S), m.tag.attributes[I] = $, L(m, "onattribute", $);
          }
...
function Kr() {
  return Er || (Er = 1, function() {
    ...
    }, te.firstCharLowerCase = function(t) {
      return t.charAt(0).toLowerCase() + t.slice(1);
    }, te.stripPrefix = function(t) {
      return t.replace(o, "");
    }, te.parseNumbers = function(t) {
      return isNaN(t) || (t = t % 1 === 0 ? parseInt(t, 10) : parseFloat(t)), t;
    }, te.parseBooleans = function(t) {
...
function Xo() {
  return Dr || (Dr = 1, function(o) {
    (function() {
      var t, e, n, s, i, r, a, c, g, p = function(b, O) {
        return function() {
        ...
        return w.prototype = O.prototype, b.prototype = new w(), b.__super__ = O.prototype, b;
      }, h = {}.hasOwnProperty;
      c = Bo(), s = $n, t = Uo(), a = Kr(), g = hs.setImmediate, e = qn().defaults, i = function(b) {
        return typeof b == "object" && b != null && Object.keys(b).length === 0;
      }, r = function(b, O, D) {
        var w, A, C;
        for (w = 0, A = b.length; w < A; w++)
          C = b[w], O = C(O, D);
        return O;
      }, n = function(b, O, D) {
        var w;
        return w = /* @__PURE__ */ Object.create(null), w.value = D, w.writable = !0, w.enumerable = !0, w.configurable = !0, Object.defineProperty(b, O, w);
      }, o.Parser = function(b) {
        f(O, b);
        function O(D) {
          ...
          if (!(this instanceof o.Parser))
            return new o.Parser(D);
          this.options = {}, A = e["0.2"];
          for (w in A)
            h.call(A, w) && (C = A[w], this.options[w] = C);
          for (w in D)
            h.call(D, w) && (C = D[w], this.options[w] = C);
        ...
        return O.prototype.processAsync = function() {
          var D, w;
          try {
            return this.remaining.length <= this.options.chunkSize ? (D = this.remaining, this.remaining = "", this.saxParser = this.saxParser.write(D), this.saxParser.close()) : (D = this.remaining.substr(0, this.options.chunkSize), this.remaining = this.remaining.substr(this.options.chunkSize, this.remaining.length), this.saxParser = this.saxParser.write(D), g(this.processAsync));
          } catch (A) {
            if (w = A, !this.saxParser.errThrown)
              return this.saxParser.errThrown = !0, this.emit(w);
          }
        }, O.prototype.assignOrPush = function(D, w, A) {
          return w in D ? (D[w] instanceof Array || n(D, w, [D[w]]), D[w].push(A)) : this.options.explicitArray ? n(D, w, [A]) : n(D, w, A);
          ...
          return this.removeAllListeners(), this.saxParser = c.parser(this.options.strict, {
          ...
          }), this.saxParser.errThrown = !1, this.saxParser.onerror = /* @__PURE__ */ function(d) {
            return function(E) {
              if (d.saxParser.resume(), !d.saxParser.errThrown)
                return d.saxParser.errThrown = !0, d.emit("error", E);
            };
          }(this), this.saxParser.onend = /* @__PURE__ */ function(d) {
            return function() {
            ...
            return function(E) {
              var T, F;
              if (F = C[C.length - 1], F)
                return F[w] += E, d.options.explicitChildren && d.options.preserveChildrenOrder && d.options.charsAsChildren && (d.options.includeWhiteChars || E.replace(/\\n/g, "").trim() !== "") && (F[d.options.childkey] = F[d.options.childkey] || [], T = {
                  "#name": "__text__"
                }, T[w] = E, d.options.normalize && (T[w] = T[w].replace(/\s{2,}/g, " ").trim()), F[d.options.childkey].push(T)), F;
            };
          }(this), this.saxParser.ontext = A, this.saxParser.oncdata = /* @__PURE__ */ function(d) {
            return function(E) {
              var T;
              if (T = A(E), T)
                return T.cdata = !0;
        ...
        }, O.prototype.parseString = function(D, w) {
          var A;
          w != null && typeof w == "function" && (this.on("end", function(C) {
            return this.reset(), w(null, C);
          }), this.on("error", function(C) {
            return this.reset(), w(C);
          }));
          try {
            return D = D.toString(), D.trim() === "" ? (this.emit("end", null), !0) : (D = t.stripBOM(D), this.options.async ? (this.remaining = D, g(this.processAsync), this.saxParser) : this.saxParser.write(D).close());
          } catch (C) {
            if (A = C, this.saxParser.errThrown || this.saxParser.ended) {
              if (this.saxParser.ended)
                throw A;
            } else return this.emit("error", A), this.saxParser.errThrown = !0;
          }
        }, O.prototype.parseStringPromise = function(D) {
          return new Promise(/* @__PURE__ */ function(w) {
            return function(A, C) {
              return w.parseString(D, function(d, E) {
                return d ? C(d) : A(E);
              });
            };
          }(this));
        }, O;
      }(s), o.parseString = function(b, O, D) {
        var w, A, C;
        return D != null ? (typeof D == "function" && (w = D), typeof O == "object" && (A = O)) : (typeof O == "function" && (w = O), A = {}), C = new o.Parser(A), C.parseString(b, w);
      }, o.parseStringPromise = function(b, O) {
        var D, w;
        return typeof O == "object" && (D = O), w = new o.Parser(D), w.parseStringPromise(b);
      };
    }).call(et);
  }(An)), An;
}
...
(function() {
  ...
  t = qn(), o = Ro(), e = Xo(), Kr(), t.defaults, function(i) {
    n(r, i);
    function r(a) {
      this.message = a;
    }
    return r;
  }(Error), o.Builder, e.Parser, e.parseString, Qr = e.parseStringPromise;
}).call(et);
class $o {
  constructor(t, e, n) {
...
`), a = r.map((f, h) => h === 0 ? "AAAA" : "AACA").join(";"), c = {
        version: 3,
  ...
  getOrCreateScriptId(t) {
    ...
    return e || (e = fs("sha256").update(String(this.nextScriptId++)).digest("hex").slice(0, 16), this.scriptIdByUrl.set(t, e)), e;
  }
  ...
  async handleCdpMessage(t) {
    ...
    switch (n) {
      ...
      case "Debugger.setBreakpointByUrl": {
        const { url: a, lineNumber: c } = s;
        if (!a) {
          r = !1;
          break;
        }
        const g = this.uriFromCDPToBridge(a), p = this.uriFromBridgeToDBGP(g), f = (typeof c == "number" ? c : 0) + 1, h = String(this.breakpoints.size + 1);
        if (this.xdebugConnected) {
          const b = `breakpoint_set -t line -f ${this.formatPropertyFullName(
            p
          )} -n ${f}`, O = this.sendDbgpCommand(b);
          this.pendingCommands.set(O, {
            cdpId: e,
            cdpMethod: n,
            params: {
              breakpointId: h,
          ...
          this.breakpoints.set(h, {
            ...
            locations: [
              {
                scriptId: this.getOrCreateScriptId(g),
                lineNumber: f - 1,
                columnNumber: 0
              }
            ]
      ...
      case "Debugger.removeBreakpoint": {
        const { breakpointId: a } = s, c = String(a), g = this.breakpoints.get(c);
        if (g) {
          if (g.xdebugId && this.xdebugConnected) {
            const p = `breakpoint_remove -d ${g.xdebugId}`, f = this.sendDbgpCommand(p);
            this.pendingCommands.set(f, {
              cdpId: e,
              cdpMethod: n
            }), r = !1;
          }
          this.breakpoints.delete(c);
        }
        i = {};
        break;
      }
      ...
      case "Debugger.evaluateOnCallFrame": {
        const a = s.expression || "", c = s.callFrameId;
        if (n === "Debugger.evaluateOnCallFrame") {
          if (c === void 0 || !this.callFramesMap.has(c)) {
            this.cdp.sendMessage({
              id: e,
              error: {
                code: -32e3,
        ...
        if (this.xdebugConnected) {
          const g = Buffer.from(a).toString("base64"), p = this.sendDbgpCommand("eval", `-- ${g}`);
      ...
      case "Runtime.getProperties": {
        ...
        if (c && this.xdebugConnected)
          if (c.type === "context") {
            const g = c.contextId ?? 0, f = `context_get -d ${c.depth} -c ${g} -p 0 -m 32`, h = this.sendDbgpCommand(f), b = {
              ...c,
              currentPage: 0,
              aggregatedProps: []
            };
            ...
            const g = c.depth, p = c.fullname, f = this.formatPropertyFullName(p), h = `property_get -d ${g} -n ${f} -p 0 -m 32`, b = this.sendDbgpCommand(h), O = {
              ...c,
              currentPage: 0,
              aggregatedProps: []
            };
            this.objectHandles.set(a, O), this.pendingCommands.set(b, {
              cdpId: e,
              cdpMethod: n,
      ...
      case "Debugger.getScriptSource": {
        const a = s.scriptId, c = [...this.scriptIdByUrl.entries()].find(
          ([, p]) => p === a
        )?.[0], g = [];
        c && g.push(
...
`)
  ...
  uriFromBridgeToDBGP(t) {
    return Cr.resolve(process.cwd(), t);
  }
    ...
    if (t.response) {
      ...
      switch (s) {
        ...
        case "step_out": {
          const a = n.status;
          if (e["xdebug:message"]) {
            const c = this.uriFromDBGPToBridge(
              e["xdebug:message"].$.filename
            );
            c && !this.scriptIdByUrl.has(c) && await this.sendScriptToCDP(
              c,
              this.getOrCreateScriptId(c)
            );
          }
          if (a === "break") {
            const c = this.sendDbgpCommand("stack_get");
            this.pendingCommands.set(c, {
              /* internal stack get */
            }), this.pendingCommands.delete(i);
          } else (a === "stopping" || a === "stopped") && this.cdp.sendMessage({
        ...
        case "eval": {
          if (r && r.cdpId !== void 0) {
            let a;
            if (e.property) {
              const g = e.property, p = g.$.type, f = g.$.encoding;
              let h = null;
              if (Object.prototype.hasOwnProperty.call(
                g,
                "_"
              ) ? h = g._ : typeof g.$value < "u" && (h = g.$value), f === "base64" && h !== null)
                try {
                  h = Buffer.from(h, "base64").toString();
                } catch {
                }
              if (p === "string")
                a = {
                ...
                const b = g.$.classname || (p === "array" ? "Array" : "Object"), O = String(this.nextObjectId++), D = g.$.fullname || "";
                this.objectHandles.set(O, {
                  type: "property",
                  depth: 0,
                  contextId: 0,
                  fullname: D
            ...
            const c = { result: a };
            this.cdp.sendMessage({ id: r.cdpId, result: c }), this.pendingCommands.delete(i);
          }
          break;
        }
        case "context_get":
        case "property_get": {
          if (r && r.cdpId !== void 0) {
            const a = r.params?.objectId || r.params?.parentObjectId, c = a ? this.objectHandles.get(a) : null, g = e.property?.property ?? e.property, p = [];
            if (g) {
              const f = Array.isArray(g) ? g : [g];
              for (const h of f) {
                const b = h.$.name || h.$.fullname || "";
                let O = h.$.type || "undefined";
                const D = h.$.children === "1", w = h.$.encoding;
                let A = null;
                if (typeof h._ < "u" && (A = h._), w === "base64" && A !== null)
                  try {
                    A = Buffer.from(
                      A,
                      "base64"
                ...
                if (D) {
                  const C = h.$.classname || (O === "array" ? "Array" : "Object"), d = String(
                    this.nextObjectId++
                  ), E = r.cdpMethod === "Runtime.getProperties" && r.params?.parentObjectId && this.objectHandles.get(
                    r.params.parentObjectId
                  )?.contextId || 0, T = r.cdpMethod === "Runtime.getProperties" && r.params?.parentObjectId && this.objectHandles.get(
                    r.params.parentObjectId
                  )?.depth || 0;
                  ...
                  let C, d;
                  O === "string" ? C = A ?? "" : O === "int" || O === "integer" ? C = parseInt(A || "0", 10) : O === "float" || O === "double" ? C = parseFloat(A || "0") : O === "bool" || O === "boolean" ? (C = A === "1" || A === "true", O = "boolean") : O === "null" ? (C = null, d = "null") : C = A;
                  const E = {
                    type: O === "integer" ? "number" : O
                  };
                  d && (E.subtype = d), E.value = C, p.push({
                    name: h.$.key || b,
                    value: E,
                    writable: !1,
                    configurable: !1,
            ...
            if (c) {
              const f = (c.aggregatedProps || []).concat(p), h = 32;
              if (p.length === h) {
                const O = (c.currentPage || 0) + 1, D = {
                  ...c,
                  currentPage: O,
                  aggregatedProps: f
                };
                ...
                if (s === "context_get") {
                  ...
                  w = `context_get -d ${c.depth} -c ${C} -p ${O} -m ${h}`;
                } else {
                  const C = c.depth, d = c.fullname, E = this.formatPropertyFullName(d);
                  w = `property_get -d ${C} -n ${E} -p ${O} -m ${h}`;
                }
                const A = this.sendDbgpCommand(w);
              ...
              const f = { result: p };
              this.cdp.sendMessage({ id: r.cdpId, result: f }), this.pendingCommands.delete(i);
            }
          }
          break;
        }
        case "stack_get": {
          if (e.stack) {
            const a = Array.isArray(e.stack) ? e.stack : [e.stack], c = [];
            this.callFramesMap.clear();
            for (const p of a) {
              const f = this.uriFromDBGPToBridge(
                p.$.filename
              ), h = this.getOrCreateScriptId(f);
              this.scriptIdByUrl.has(f) || (this.scriptIdByUrl.set(f, h), await this.sendScriptToCDP(f, h));
            }
            for (const p of a) {
              const f = parseInt(p.$.level, 10), h = this.uriFromDBGPToBridge(
                p.$.filename
              ), b = parseInt(p.$.lineno, 10), O = p.$.where && p.$.where !== "{main}" ? p.$.where : "(anonymous)", D = `frame:${f}`;
              this.callFramesMap.set(D, f);
              const w = [], A = String(this.nextObjectId++);
              this.objectHandles.set(A, {
                type: "context",
                contextId: 0,
                depth: f
              }), w.push({
...
`
  ...
  async function c(f) {
    ...
    for (const O of b) {
      const D = Cr.join(f, O);
      try {
        (o.phpInstance ? await o.phpInstance.isDir(D) : os(D).isDirectory()) ? h.push(...await c(D)) : O.endsWith(".php") && h.push(D);
      } catch {
      }
    }
    return h;
  }
  const g = o.phpInstance ? (f) => o.phpInstance.readFileAsText(f) : o.getPHPFile ? o.getPHPFile : (f) => Le(f, "utf-8"), p = await c(s);
  return new $o(a, r, {
    knownScriptUrls: p,
    phpRoot: s,
    getPHPFile: g,
...
const Jr = {
  Quiet: { name: "quiet", severity: yt.Fatal },
  Normal: { name: "normal", severity: yt.Info },
